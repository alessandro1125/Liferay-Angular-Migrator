Liferay.Loader.define('@example-angular-liferay$angular/http@6.1.10/esm2015/src/backends/jsonp_backend', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    JSONPBackend.decorators = [{ type: Injectable }];
    /** @nocollapse */
    JSONPBackend.ctorParameters = () => [{ type: BrowserJsonp }, { type: ResponseOptions }];
    if (false) {
        /** @type {?} */
