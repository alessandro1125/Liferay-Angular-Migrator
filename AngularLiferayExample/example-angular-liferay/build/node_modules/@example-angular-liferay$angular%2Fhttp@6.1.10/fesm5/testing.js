Liferay.Loader.define('@example-angular-liferay$angular/http@6.1.10/fesm5/testing', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var MockBackend = /** @class */function () {
    ...
    MockBackend = __decorate([Injectable(), __metadata("design:paramtypes", [])], MockBackend);
    return MockBackend;
  }();
