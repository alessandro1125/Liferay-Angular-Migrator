Liferay.Loader.define('@example-angular-liferay$angular/http@6.1.10/esm5/testing/src/mock_backend', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var MockBackend = /** @class */function () {
        ...
        MockBackend = tslib_1.__decorate([Injectable(), tslib_1.__metadata("design:paramtypes", [])], MockBackend);
        return MockBackend;
    }();
    export { MockBackend };
});
