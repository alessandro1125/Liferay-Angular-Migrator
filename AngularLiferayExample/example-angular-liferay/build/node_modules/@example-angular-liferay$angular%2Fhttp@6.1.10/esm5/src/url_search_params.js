Liferay.Loader.define('@example-angular-liferay$angular/http@6.1.10/esm5/src/url_search_params', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    function paramParser(rawParams) {
        ...
        if (rawParams.length > 0) {
            ...
            params.forEach(function (param) {
                ...
                var _a = tslib_1.__read(eqIdx == -1 ? [param, ''] : [param.slice(0, eqIdx), param.slice(eqIdx + 1)], 2),
                    key = _a[0],
                    val = _a[1];
