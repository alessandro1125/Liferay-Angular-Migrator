Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/di/r3_injector', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class R3Injector {
        ...
        constructor(def, additionalProviders, parent) {
            ...
            additionalProviders && deepForEach(additionalProviders, provider => this.processProvider(provider));
        ...
        get(token, notFoundValue = THROW_IF_NOT_FOUND, flags = 0 /* Default */) {
            ...
            try {
                ...
                if (!(flags & 4 /* SkipSelf */)) {
                    ...
                    if (record === undefined) {
                        /** @type {?} */
                        const def = couldBeInjectableType(token) && /** @type {?} */token.ngInjectableDef || undefined;
        ...
        processInjectorType(defOrWrappedDef, parents) {
            ...
            /** @type {?} */
            const providers = ngModule !== undefined && /** @type {?} */defOrWrappedDef.providers || EMPTY_ARRAY;
