Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/view/element', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function elementDef(checkIndex, flags, matchedQueriesDsl, ngContentIndex, childCount, namespaceAndName, fixedAttrs = [], bindings, outputs, handleEvent, componentView, componentRendererType) {
        ...
        for (let i = 0; i < bindings.length; i++) {
            ...
            bindingDefs[i] = { flags: bindingFlags, ns, name, nonMinifiedName: name, securityContext, suffix };
        }
        outputs = outputs || [];
        /** @type {?} */
