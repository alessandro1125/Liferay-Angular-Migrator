Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/application_init', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    /** @nocollapse */
    ApplicationInitStatus.ctorParameters = () => [{ type: Array, decorators: [{ type: Inject, args: [APP_INITIALIZER] }, { type: Optional }] }];
    if (false) {
        /** @type {?} */
