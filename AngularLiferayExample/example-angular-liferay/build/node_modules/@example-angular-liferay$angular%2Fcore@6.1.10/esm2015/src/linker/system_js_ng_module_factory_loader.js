Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/linker/system_js_ng_module_factory_loader', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    /** @nocollapse */
    SystemJsNgModuleLoader.ctorParameters = () => [{ type: Compiler }, { type: SystemJsNgModuleLoaderConfig, decorators: [{ type: Optional }] }];
    if (false) {
        /** @type {?} */
