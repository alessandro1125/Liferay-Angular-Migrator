Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/render3/query', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class LQueries_ {
        ...
        insertView(index) {
            ...
            let query = this.deep;
            while (query) {
                ngDevMode && assertDefined(query.containerValues, 'View queries need to have a pointer to container values.'); /** @type {?} */
