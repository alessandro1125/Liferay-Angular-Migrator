Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/render3/instructions', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function createLViewData(renderer, tView, context, flags, sanitizer) {
        return [tView, viewData, null, null,
        // queries
        ...
        -1, null, null, context,
        // context
        viewData && viewData[INJECTOR], renderer,
        // renderer
        sanitizer || null, null,
        // tail
        -1, null];
    ...
    export function createLNode(index, type, native, name, attrs, state) {
        /** @type {?} */
        const parent = isParent ? previousOrParentNode : previousOrParentNode && /** @type {?} */getParentLNode(previousOrParentNode);
        /** @type {?} */
        const tParent = parent && parent.view === viewData ? /** @type {?} */parent.tNode : null;
        /** @type {?} */
        let queries = (isParent ? currentQueries : previousOrParentNode && previousOrParentNode.queries) || parent && parent.queries && parent.queries.child();
        /** @type {?} */
        ...
        if (index === -1 || type === 2 /* View */) {
                ...
                node.tNode = (state ? /** @type {?} */state[TVIEW].node : null) || createTNode(type, index, null, null, tParent, null);
            } else {
            /** @type {?} */
            ...
            if (adjustedIndex >= tData.length) {
                /** @type {?} */
                const tNode = tData[adjustedIndex] = createTNode(type, adjustedIndex, name, attrs, tParent, null);
    ...
    export function elementAttribute(index, name, value, sanitizer) {
        if (value !== NO_CHANGE) {
            ...
            if (value == null) {
                ...
                isProceduralRenderer(renderer) ? renderer.removeAttribute(element.native, name) : element.native.removeAttribute(name);
            } else {
                ngDevMode && ngDevMode.rendererSetAttribute++;
                /** @type {?} */
                const strValue = sanitizer == null ? stringify(value) : sanitizer(value);
                isProceduralRenderer(renderer) ? renderer.setAttribute(element.native, name, strValue) : element.native.setAttribute(name, strValue);
            }
        }
    }
    /**
    ...
    export function elementProperty(index, propName, value, sanitizer) {
        ...
        if (inputData && (dataValue = inputData[propName])) {
            ...
            isProceduralRenderer(renderer) ? renderer.setProperty(native, propName, value) : native.setProperty ? native.setProperty(propName, value) : /** @type {?} */native[propName] = value;
        }
    }
    /**
    ...
    function getStylingContext(index) {
        ...
        if (!Array.isArray(stylingContext)) {
            ...
            stylingContext = viewData[index + HEADER_OFFSET] = allocStylingContext(lElement, /** @type {?} */tNode.stylingTemplate);
        }
    ...
    export function baseDirectiveCreate(index, directive, directiveDef) {
        ...
        if (firstTemplatePass) {
            ...
            if (diPublic) diPublic( /** @type {?} */directiveDef);
        }
    ...
    export function createLContainer(parentLNode, currentView, isForViewContainerRef) {
        ...
        /** @type {?} */
        let renderParent = canInsertNativeNode(parentLNode, currentView) ? /** @type {?} */parentLNode : null;
        if (renderParent && renderParent.tNode.type === 2 /* View */) {
                renderParent = /** @type {?} */getParentLNode( /** @type {?} */renderParent).data[RENDER_PARENT];
            }
        return [isForViewContainerRef ? null : 0, currentView, null, null,
        // queries
        [],
        /** @type {?} */renderParent];
    }
    ...
    export function projectionDef(selectors, textSelectors) {
        ...
        if (!componentNode.tNode.projection) {
            ...
            /** @type {?} */
            const pData = componentNode.tNode.projection = new Array(noOfNodeBuckets).fill(null);
            /** @type {?} */
    ...
    export function projection(nodeIndex, selectorIndex = 0, attrs) {
        ...
        if (canInsertNativeNode(parent, viewData)) {
            ...
            let grandparent;
            /** @type {?} */
            const renderParent = parent.tNode.type === 2 /* View */ ? (grandparent = /** @type {?} */getParentLNode(parent)) &&
