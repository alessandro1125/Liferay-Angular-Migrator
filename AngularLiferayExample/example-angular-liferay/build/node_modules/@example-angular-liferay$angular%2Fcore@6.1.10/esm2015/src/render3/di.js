Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/render3/di', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    function getOrCreateHostChangeDetector(currentNode) {
        ...
        return existingRef ? existingRef : new ViewRef( /** @type {?} */hostNode.data, /** @type {?} */hostNode.view[DIRECTIVES][hostNode.tNode.flags >> 14 /* DirectiveStartingIndexShift */]);
    }
    /**
    ...
    class ViewContainerRef {
        ...
        createEmbeddedView(templateRef, context, index) {
            ...
            /** @type {?} */
            const viewRef = /** @type {?} */templateRef.createEmbeddedView(context || /** @type {?} */{}, this._lContainerNode, adjustedIdx);
        ...
        insert(viewRef, index) {
            ...
            /** @type {?} */
            const beforeNode = adjustedIdx + 1 < views.length ? /** @type {?} */getChildLNode(views[adjustedIdx + 1]).native : this._lContainerNode.native;
