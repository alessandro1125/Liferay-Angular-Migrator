Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/render3/i18n', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    function appendI18nNode(node, parentNode, previousNode) {
        ...
        if (firstTemplatePass) {
            ...
            if (parentNode.view === node.view) node.tNode.parent = /** @type {?} */parentNode.tNode;
        }
