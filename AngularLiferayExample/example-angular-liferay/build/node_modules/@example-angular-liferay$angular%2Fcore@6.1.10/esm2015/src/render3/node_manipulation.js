Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/render3/node_manipulation', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    function walkLNodeTree(startingNode, rootNode, action, renderer, renderParentNode, beforeNode) {
        ...
        while (node) {
            ...
            if (nodeType === 3 /* Element */) {
                    ...
                    /** @type {?} */
                    const childContainerData = lContainerNode.dynamicLContainerNode ? lContainerNode.dynamicLContainerNode.data : lContainerNode.data;
                    if (renderParentNode) {
    ...
    export function appendChild(parent, child, currentView) {
        if (child !== null && canInsertNativeNode(parent, currentView)) {
            ...
            if (parent.tNode.type === 2 /* View */) {
                    ...
                    isProceduralRenderer(renderer) ? renderer.insertBefore( /** @type {?} */renderParent.native, child, beforeNode) : /** @type {?} */renderParent.native.insertBefore(child, beforeNode, true);
                } else {
