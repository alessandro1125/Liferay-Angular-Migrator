Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/application_ref', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class PlatformRef {
        ...
        bootstrapModuleFactory(moduleFactory, options) {
            ...
            return ngZone.run(() => {
                ...
                ngZone.runOutsideAngular(() => /** @type {?} */ngZone.onError.subscribe({ next: error => {
        ...
        bootstrapModule(moduleType, compilerOptions = []) {
            ...
            return compiler.compileModuleAsync(moduleType).then(moduleFactory => this.bootstrapModuleFactory(moduleFactory, options));
        }
        /**
         * @param {?} moduleRef
         * @return {?}
    ...
    /** @nocollapse */
    ApplicationRef.ctorParameters = () => [{ type: NgZone }, { type: Console }, { type: Injector }, { type: ErrorHandler }, { type: ComponentFactoryResolver }, { type: ApplicationInitStatus }];
    if (false) {
        /**
         * \@internal
         * @type {?}
