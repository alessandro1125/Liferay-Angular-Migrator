Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/sanitization/sanitization', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export const defaultStyleSanitizer = /** @type {?} */function (prop, value) {
        if (value === undefined) {
            return prop === 'background-image' || prop === 'background' || prop === 'border-image' || prop === 'filter' || prop === 'filter' || prop === 'list-style' || prop === 'list-style-image';
        }
