Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/src/change_detection/differs/default_iterable_differ', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class DefaultIterableDiffer {
        ...
        forEachOperation(fn) {
            ...
            while (nextIt || nextRemove) {
                /** @type {?} */
                const record = !nextRemove || nextIt && /** @type {?} */nextIt.currentIndex < getPreviousIndex(nextRemove, addRemoveOffset, moveOffsets) ? /** @type {?} */
                nextIt : nextRemove;
                /** @type {?} */
