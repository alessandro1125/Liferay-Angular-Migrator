Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm2015/testing/src/test_bed', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class TestBed {
        ...
        _createCompilerAndModule() {
            ...
            if (this._isRoot) {
                ...
                RootScopeModule.decorators = [{ type: NgModule, args: [{
            ...
            DynamicTestModule.decorators = [{ type: NgModule, args: [{ providers, declarations, imports, schemas, jit: true }] }];
            /** @type {?} */
        ...
        overrideTemplateUsingTestingModule(component, template) {
            ...
            OverrideComponent.decorators = [{ type: Component, args: [{ selector: 'empty', template, jit: true }] }];
