Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm5/testing/src/test_bed', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var TestBed = /** @class */function () {
        ...
        TestBed.prototype._initIfNeeded = function () {
            ...
            if (!this._moduleFactory) {
                try {
                    ...
                    if (errorCompType) {
                        throw new Error("This test module uses the component " + stringify(errorCompType) + " which is using a \"templateUrl\" or \"styleUrls\", but they were never compiled. " + "Please call \"TestBed.compileComponents\" before your test.");
                    } else {
                        throw e;
                    }
                }
        ...
        TestBed.prototype._createCompilerAndModule = function () {
            ...
            if (this._isRoot) {
                var RootScopeModule = /** @class */function () {
                    ...
                    RootScopeModule = tslib_1.__decorate([NgModule({
            ...
            var DynamicTestModule = /** @class */function () {
                ...
                DynamicTestModule = tslib_1.__decorate([NgModule({ providers: providers, declarations: declarations, imports: imports, schemas: schemas, jit: true })], DynamicTestModule);
        ...
        TestBed.prototype.overrideTemplateUsingTestingModule = function (component, template) {
            ...
            var OverrideComponent = /** @class */function () {
                ...
                OverrideComponent = tslib_1.__decorate([Component({ selector: 'empty', template: template, jit: true })], OverrideComponent);
