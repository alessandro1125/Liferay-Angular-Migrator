Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm5/src/view/provider', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function directiveDef(checkIndex, flags, matchedQueries, childCount, ctor, deps, props, outputs) {
        ...
        if (props) {
            for (var prop in props) {
                var _a = tslib_1.__read(props[prop], 2),
                    bindingIndex = _a[0],
    ...
    function updateProp(view, providerData, def, bindingIdx, value, changes) {
        ...
        if (def.flags & 524288 /* OnChanges */) {
                ...
                changes[binding_1.nonMinifiedName] = new SimpleChange(oldValue, value, (view.state & 2 /* FirstCheck */) !== 0);
            }
