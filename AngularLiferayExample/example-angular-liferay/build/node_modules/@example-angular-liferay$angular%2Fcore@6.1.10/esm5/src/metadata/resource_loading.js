Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm5/src/metadata/resource_loading', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function resolveComponentResources(resourceResolver) {
        ...
        return Promise.all(urlFetches).then(function () {
            return null;
        });
    }
