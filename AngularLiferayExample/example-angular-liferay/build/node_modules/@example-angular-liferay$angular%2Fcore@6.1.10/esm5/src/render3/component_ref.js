Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm5/src/render3/component_ref', ['module', 'exports', 'require'], function (module, exports, require) {
     ...
     */
    export var ROOT_CONTEXT = new InjectionToken('ROOT_CONTEXT_TOKEN', { providedIn: 'root', factory: function () {
     ...
     */
    export var SCHEDULER = new InjectionToken('SCHEDULER_TOKEN', { providedIn: 'root', factory: function () {
    ...
    var ComponentFactory = /** @class */function (_super) {
        ...
        ComponentFactory.prototype.create = function (injector, projectableNodes, rootSelectorOrNode, ngModule) {
            ...
            var hostNode = isInternalRootView ? elementCreate(this.selector, rendererFactory.createRenderer(null, this.componentDef.rendererType)) : locateHostElement(rendererFactory, rootSelectorOrNode);
