Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/esm5/src/render3/pure_function', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function pureFunction0(slotOffset, pureFn, thisArg) {
        ...
        var value = getCreationMode() ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg) : pureFn()) : consumeBinding();
    ...
    export function pureFunction1(slotOffset, pureFn, exp, thisArg) {
        ...
        var index = moveBindingIndexToReservedSlot(slotOffset);
        var value = bindingUpdated(exp) ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp) : pureFn(exp)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction2(slotOffset, pureFn, exp1, exp2, thisArg) {
        ...
        var index = moveBindingIndexToReservedSlot(slotOffset);
        var value = bindingUpdated2(exp1, exp2) ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2) : pureFn(exp1, exp2)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction3(slotOffset, pureFn, exp1, exp2, exp3, thisArg) {
        ...
        var value = bindingUpdated(exp3) || different ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3) : pureFn(exp1, exp2, exp3)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction4(slotOffset, pureFn, exp1, exp2, exp3, exp4, thisArg) {
        ...
        var index = moveBindingIndexToReservedSlot(slotOffset);
        var value = bindingUpdated4(exp1, exp2, exp3, exp4) ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3, exp4) : pureFn(exp1, exp2, exp3, exp4)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction5(slotOffset, pureFn, exp1, exp2, exp3, exp4, exp5, thisArg) {
        ...
        var value = bindingUpdated(exp5) || different ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3, exp4, exp5) : pureFn(exp1, exp2, exp3, exp4, exp5)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction6(slotOffset, pureFn, exp1, exp2, exp3, exp4, exp5, exp6, thisArg) {
        ...
        var index = moveBindingIndexToReservedSlot(slotOffset);
        var different = bindingUpdated4(exp1, exp2, exp3, exp4);
        var value = bindingUpdated2(exp5, exp6) || different ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3, exp4, exp5, exp6) : pureFn(exp1, exp2, exp3, exp4, exp5, exp6)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction7(slotOffset, pureFn, exp1, exp2, exp3, exp4, exp5, exp6, exp7, thisArg) {
        ...
        var value = bindingUpdated(exp7) || different ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3, exp4, exp5, exp6, exp7) : pureFn(exp1, exp2, exp3, exp4, exp5, exp6, exp7)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
    ...
    export function pureFunction8(slotOffset, pureFn, exp1, exp2, exp3, exp4, exp5, exp6, exp7, exp8, thisArg) {
        ...
        var index = moveBindingIndexToReservedSlot(slotOffset);
        var different = bindingUpdated4(exp1, exp2, exp3, exp4);
        var value = bindingUpdated4(exp5, exp6, exp7, exp8) || different ? checkAndUpdateBinding(thisArg ? pureFn.call(thisArg, exp1, exp2, exp3, exp4, exp5, exp6, exp7, exp8) : pureFn(exp1, exp2, exp3, exp4, exp5, exp6, exp7, exp8)) : consumeBinding();
        restoreBindingIndex(index);
        return value;
    }
    /**
