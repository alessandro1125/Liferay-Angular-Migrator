Liferay.Loader.define('@example-angular-liferay$angular/core@6.1.10/bundles/core-testing.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/core'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/core')) : typeof define === 'function' && define.amd ? define('@angular/core/testing', ['exports', '@angular/core'], factory) : factory((global.ng = global.ng || {}, global.ng.core = global.ng.core || {}, global.ng.core.testing = {}), global.ng.core);
        ...
        ***************************************************************************** */
        ...
        var TestingCompiler = /** @class */function (_super) {
            ...
            TestingCompiler = __decorate([core.Injectable()], TestingCompiler);
        ...
        var TestBed = /** @class */function () {
            ...
            TestBed.prototype._initIfNeeded = function () {
                ...
                if (!this._moduleFactory) {
                    try {
                        ...
                        if (errorCompType) {
                            throw new Error("This test module uses the component " + core.ɵstringify(errorCompType) + " which is using a \"templateUrl\" or \"styleUrls\", but they were never compiled. " + "Please call \"TestBed.compileComponents\" before your test.");
                        } else {
                            throw e;
                        }
                    }
            ...
            TestBed.prototype._createCompilerAndModule = function () {
                ...
                if (this._isRoot) {
                    var RootScopeModule = /** @class */function () {
                        ...
                        RootScopeModule = __decorate([core.NgModule({
                ...
                var DynamicTestModule = /** @class */function () {
                    ...
                    DynamicTestModule = __decorate([core.NgModule({ providers: providers, declarations: declarations, imports: imports, schemas: schemas, jit: true })], DynamicTestModule);
            ...
            TestBed.prototype.overrideProviderImpl = function (token, provider, deprecated) {
                ...
                if (typeof token !== 'string' && token.ngInjectableDef && token.ngInjectableDef.providedIn === 'root') {
            ...
            TestBed.prototype.overrideTemplateUsingTestingModule = function (component, template) {
                ...
                var OverrideComponent = /** @class */function () {
                    ...
                    OverrideComponent = __decorate([core.Component({ selector: 'empty', template: template, jit: true })], OverrideComponent);
