Liferay.Loader.define('@example-angular-liferay$angular/router@6.1.10/esm5/testing/src/router_testing_module', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var SpyNgModuleFactoryLoader = /** @class */function () {
        ...
        SpyNgModuleFactoryLoader = tslib_1.__decorate([Injectable(), tslib_1.__metadata("design:paramtypes", [Compiler])], SpyNgModuleFactoryLoader);
    ...
    var RouterTestingModule = /** @class */function () {
        ...
        RouterTestingModule.withRoutes = function (routes, config) {
            return {
                ...
                providers: [provideRoutes(routes), { provide: ROUTER_CONFIGURATION, useValue: config ? config : {} }]
            };
        };
        var RouterTestingModule_1;
        RouterTestingModule = RouterTestingModule_1 = tslib_1.__decorate([NgModule({
            exports: [RouterModule],
            providers: [ROUTER_PROVIDERS, { provide: Location, useClass: SpyLocation }, { provide: LocationStrategy, useClass: MockLocationStrategy }, { provide: NgModuleFactoryLoader, useClass: SpyNgModuleFactoryLoader }, {
                provide: Router,
