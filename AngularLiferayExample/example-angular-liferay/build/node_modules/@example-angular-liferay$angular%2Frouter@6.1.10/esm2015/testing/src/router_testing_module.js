Liferay.Loader.define('@example-angular-liferay$angular/router@6.1.10/esm2015/testing/src/router_testing_module', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    /** @nocollapse */
    SpyNgModuleFactoryLoader.ctorParameters = () => [{ type: Compiler }];
    if (false) {
        /**
         * \@docsNotRequired
         * @type {?}
