Liferay.Loader.define('@example-angular-liferay$angular/forms@6.1.10/esm2015/src/directives/reactive_directives/form_control_directive', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  FormControlDirective.decorators = [{ type: Directive, args: [{ selector: '[formControl]', providers: [formControlBinding], exportAs: 'ngForm' }] }];
  /** @nocollapse */
