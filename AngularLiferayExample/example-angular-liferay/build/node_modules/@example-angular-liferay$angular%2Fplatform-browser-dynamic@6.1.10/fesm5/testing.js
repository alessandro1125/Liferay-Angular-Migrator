Liferay.Loader.define('@example-angular-liferay$angular/platform-browser-dynamic@6.1.10/fesm5/testing', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var DOMTestComponentRenderer = /** @class */function (_super) {
        ...
        DOMTestComponentRenderer = __decorate([Injectable(), __param(0, Inject(DOCUMENT)), __metadata("design:paramtypes", [Object])], DOMTestComponentRenderer);
     ...
     * found in the LICENSE file at https://angular.io/license
     */
    var COMPILER_PROVIDERS = [{ provide: MockPipeResolver, deps: [CompileReflector] }, { provide: PipeResolver, useExisting: MockPipeResolver }, { provide: MockDirectiveResolver, deps: [CompileReflector] }, { provide: DirectiveResolver, useExisting: MockDirectiveResolver }, { provide: MockNgModuleResolver, deps: [CompileReflector] }, { provide: NgModuleResolver, useExisting: MockNgModuleResolver }];
     ...
     * @experimental
     */
    var platformCoreDynamicTesting = createPlatformFactory(ɵplatformCoreDynamic, 'coreDynamicTesting', [{ provide: COMPILER_OPTIONS, useValue: { providers: COMPILER_PROVIDERS }, multi: true }, {
    ...
    var BrowserDynamicTestingModule = /** @class */function () {
        ...
        BrowserDynamicTestingModule = __decorate([NgModule({
