Liferay.Loader.define('@example-angular-liferay$angular/platform-browser-dynamic@6.1.10/esm2015/src/compiler_factory', ['module', 'exports', 'require'], function (module, exports, require) {
     ...
     * template compilation.
      @type {?} */
    export const COMPILER_PROVIDERS = /** @type {?} */[{ provide: CompileReflector, useValue: new JitReflector() }, { provide: ResourceLoader, useValue: _NO_RESOURCE_LOADER }, { provide: JitSummaryResolver, deps: [] }, { provide: SummaryResolver, useExisting: JitSummaryResolver }, { provide: Console, deps: [] }, { provide: Lexer, deps: [] }, { provide: Parser, deps: [Lexer] }, {
