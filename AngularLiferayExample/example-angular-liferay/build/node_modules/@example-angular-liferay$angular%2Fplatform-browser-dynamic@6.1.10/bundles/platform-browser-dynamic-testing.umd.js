Liferay.Loader.define('@example-angular-liferay$angular/platform-browser-dynamic@6.1.10/bundles/platform-browser-dynamic-testing.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/core', '@example-angular-liferay$angular/core/testing', '@example-angular-liferay$angular/platform-browser', '@example-angular-liferay$angular/compiler', '@example-angular-liferay$angular/compiler/testing', '@example-angular-liferay$angular/platform-browser-dynamic', '@example-angular-liferay$angular/platform-browser/testing'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/core'), require('@example-angular-liferay$angular/core/testing'), require('@example-angular-liferay$angular/platform-browser'), require('@example-angular-liferay$angular/compiler'), require('@example-angular-liferay$angular/compiler/testing'), require('@example-angular-liferay$angular/platform-browser-dynamic'), require('@example-angular-liferay$angular/platform-browser/testing')) : typeof define === 'function' && define.amd ? define('@angular/platform-browser-dynamic/testing', ['exports', '@angular/core', '@angular/core/testing', '@angular/platform-browser', '@angular/compiler', '@angular/compiler/testing', '@angular/platform-browser-dynamic', '@angular/platform-browser/testing'], factory) : factory((global.ng = global.ng || {}, global.ng.platformBrowserDynamic = global.ng.platformBrowserDynamic || {}, global.ng.platformBrowserDynamic.testing = {}), global.ng.core, global.ng.core.testing, global.ng.platformBrowser, global.ng.compiler, global.ng.compiler.testing, global.ng.platformBrowserDynamic, global.ng.platformBrowser.testing);
    })(this, function (exports, core, testing, platformBrowser, compiler, testing$1, platformBrowserDynamic, testing$2) {
        'use strict';
        ...
        ***************************************************************************** */
        ...
        var DOMTestComponentRenderer = /** @class */function (_super) {
            ...
            DOMTestComponentRenderer = __decorate([core.Injectable(), __param(0, core.Inject(platformBrowser.DOCUMENT)), __metadata("design:paramtypes", [Object])], DOMTestComponentRenderer);
         ...
         * found in the LICENSE file at https://angular.io/license
         */
        var COMPILER_PROVIDERS = [{ provide: testing$1.MockPipeResolver, deps: [compiler.CompileReflector] }, { provide: compiler.PipeResolver, useExisting: testing$1.MockPipeResolver }, { provide: testing$1.MockDirectiveResolver, deps: [compiler.CompileReflector] }, { provide: compiler.DirectiveResolver, useExisting: testing$1.MockDirectiveResolver }, { provide: testing$1.MockNgModuleResolver, deps: [compiler.CompileReflector] }, { provide: compiler.NgModuleResolver, useExisting: testing$1.MockNgModuleResolver }];
         ...
         * @experimental
         */
        var platformCoreDynamicTesting = core.createPlatformFactory(platformBrowserDynamic.ɵplatformCoreDynamic, 'coreDynamicTesting', [{ provide: core.COMPILER_OPTIONS, useValue: { providers: COMPILER_PROVIDERS }, multi: true }, {
        ...
        var BrowserDynamicTestingModule = /** @class */function () {
            ...
            BrowserDynamicTestingModule = __decorate([core.NgModule({
                exports: [testing$2.BrowserTestingModule],
                providers: [{ provide: testing.TestComponentRenderer, useClass: DOMTestComponentRenderer }]
