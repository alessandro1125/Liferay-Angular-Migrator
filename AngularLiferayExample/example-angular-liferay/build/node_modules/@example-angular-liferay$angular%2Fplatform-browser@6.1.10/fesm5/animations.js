Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/fesm5/animations', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var BrowserAnimationBuilder = /** @class */function (_super) {
        ...
        BrowserAnimationBuilder = __decorate([Injectable(), __param(1, Inject(DOCUMENT)), __metadata("design:paramtypes", [RendererFactory2, Object])], BrowserAnimationBuilder);
    ...
    var AnimationRendererFactory = /** @class */function () {
        ...
        AnimationRendererFactory = __decorate([Injectable(), __metadata("design:paramtypes", [RendererFactory2, ɵAnimationEngine, NgZone])], AnimationRendererFactory);
    ...
    var InjectableAnimationEngine = /** @class */function (_super) {
        ...
        InjectableAnimationEngine = __decorate([Injectable(), __param(0, Inject(DOCUMENT$1)), __metadata("design:paramtypes", [Object, AnimationDriver, ɵAnimationStyleNormalizer])], InjectableAnimationEngine);
    ...
    var SHARED_ANIMATION_PROVIDERS = [{ provide: AnimationBuilder, useClass: BrowserAnimationBuilder }, { provide: ɵAnimationStyleNormalizer, useFactory: instantiateDefaultStyleNormalizer }, { provide: ɵAnimationEngine, useClass: InjectableAnimationEngine }, {
     ...
     */
    var BROWSER_ANIMATIONS_PROVIDERS = __spread([{ provide: AnimationDriver, useFactory: instantiateSupportedAnimationDriver }, { provide: ANIMATION_MODULE_TYPE, useValue: 'BrowserAnimations' }], SHARED_ANIMATION_PROVIDERS);
    /**
     * Separate providers from the actual module so that we can do a local modification in Google3 to
     * include them in the BrowserTestingModule.
     */
    var BROWSER_NOOP_ANIMATIONS_PROVIDERS = __spread([{ provide: AnimationDriver, useClass: ɵNoopAnimationDriver }, { provide: ANIMATION_MODULE_TYPE, useValue: 'NoopAnimations' }], SHARED_ANIMATION_PROVIDERS);
    ...
    var BrowserAnimationsModule = /** @class */function () {
        ...
        BrowserAnimationsModule = __decorate([NgModule({
    ...
    var NoopAnimationsModule = /** @class */function () {
        ...
        NoopAnimationsModule = __decorate([NgModule({
            exports: [BrowserModule],
