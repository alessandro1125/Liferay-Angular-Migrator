Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/fesm5/testing', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var BrowserTestingModule = /** @class */function () {
        ...
        BrowserTestingModule = __decorate([NgModule({
            exports: [BrowserModule],
            providers: [{ provide: APP_ID, useValue: 'a' }, ɵELEMENT_PROBE_PROVIDERS, { provide: NgZone, useFactory: ɵ0 }]
