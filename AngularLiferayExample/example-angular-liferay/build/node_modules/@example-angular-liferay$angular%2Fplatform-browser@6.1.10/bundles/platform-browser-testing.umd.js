Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/bundles/platform-browser-testing.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/core', '@example-angular-liferay$angular/platform-browser'], function (module, exports, require) {
    ...
    (function (global, factory) {
        ...
        ***************************************************************************** */
        ...
        var BrowserTestingModule = /** @class */function () {
            ...
            BrowserTestingModule = __decorate([core.NgModule({
                exports: [platformBrowser.BrowserModule],
                providers: [{ provide: core.APP_ID, useValue: 'a' }, platformBrowser.ɵELEMENT_PROBE_PROVIDERS, { provide: core.NgZone, useFactory: ɵ0 }]
