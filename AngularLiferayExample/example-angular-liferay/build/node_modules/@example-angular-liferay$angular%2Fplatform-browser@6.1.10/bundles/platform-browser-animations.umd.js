Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/bundles/platform-browser-animations.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/animations', '@example-angular-liferay$angular/core', '@example-angular-liferay$angular/platform-browser', '@example-angular-liferay$angular/animations/browser', '@example-angular-liferay$angular/common'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/animations'), require('@example-angular-liferay$angular/core'), require('@example-angular-liferay$angular/platform-browser'), require('@example-angular-liferay$angular/animations/browser'), require('@example-angular-liferay$angular/common')) : typeof define === 'function' && define.amd ? define('@angular/platform-browser/animations', ['exports', '@angular/animations', '@angular/core', '@angular/platform-browser', '@angular/animations/browser', '@angular/common'], factory) : factory((global.ng = global.ng || {}, global.ng.platformBrowser = global.ng.platformBrowser || {}, global.ng.platformBrowser.animations = {}), global.ng.animations, global.ng.core, global.ng.platformBrowser, global.ng.animations.browser, global.ng.common);
    })(this, function (exports, animations, core, platformBrowser, browser, common) {
        'use strict';
        ...
        ***************************************************************************** */
        ...
        var BrowserAnimationBuilder = /** @class */function (_super) {
            ...
            BrowserAnimationBuilder = __decorate([core.Injectable(), __param(1, core.Inject(platformBrowser.DOCUMENT)), __metadata("design:paramtypes", [core.RendererFactory2, Object])], BrowserAnimationBuilder);
        ...
        var AnimationRendererFactory = /** @class */function () {
            ...
            AnimationRendererFactory = __decorate([core.Injectable(), __metadata("design:paramtypes", [core.RendererFactory2, browser.ɵAnimationEngine, core.NgZone])], AnimationRendererFactory);
        ...
        var InjectableAnimationEngine = /** @class */function (_super) {
            ...
            InjectableAnimationEngine = __decorate([core.Injectable(), __param(0, core.Inject(common.DOCUMENT)), __metadata("design:paramtypes", [Object, browser.AnimationDriver, browser.ɵAnimationStyleNormalizer])], InjectableAnimationEngine);
        ...
        var SHARED_ANIMATION_PROVIDERS = [{ provide: animations.AnimationBuilder, useClass: BrowserAnimationBuilder }, { provide: browser.ɵAnimationStyleNormalizer, useFactory: instantiateDefaultStyleNormalizer }, { provide: browser.ɵAnimationEngine, useClass: InjectableAnimationEngine }, {
         ...
         */
        var BROWSER_ANIMATIONS_PROVIDERS = __spread([{ provide: browser.AnimationDriver, useFactory: instantiateSupportedAnimationDriver }, { provide: ANIMATION_MODULE_TYPE, useValue: 'BrowserAnimations' }], SHARED_ANIMATION_PROVIDERS);
        /**
         * Separate providers from the actual module so that we can do a local modification in Google3 to
         * include them in the BrowserTestingModule.
         */
        var BROWSER_NOOP_ANIMATIONS_PROVIDERS = __spread([{ provide: browser.AnimationDriver, useClass: browser.ɵNoopAnimationDriver }, { provide: ANIMATION_MODULE_TYPE, useValue: 'NoopAnimations' }], SHARED_ANIMATION_PROVIDERS);
