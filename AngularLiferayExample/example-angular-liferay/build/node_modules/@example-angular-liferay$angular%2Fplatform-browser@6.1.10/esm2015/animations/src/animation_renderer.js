Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/esm2015/animations/src/animation_renderer', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    /** @nocollapse */
    AnimationRendererFactory.ctorParameters = () => [{ type: RendererFactory2 }, { type: AnimationEngine }, { type: NgZone }];
    if (false) {
        /** @type {?} */
