Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/esm2015/src/dom/events/dom_events', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    /** @nocollapse */
    DomEventsPlugin.ctorParameters = () => [{ type: undefined, decorators: [{ type: Inject, args: [DOCUMENT] }] }, { type: NgZone }, { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [PLATFORM_ID] }] }];
    if (false) {
        /** @type {?} */
