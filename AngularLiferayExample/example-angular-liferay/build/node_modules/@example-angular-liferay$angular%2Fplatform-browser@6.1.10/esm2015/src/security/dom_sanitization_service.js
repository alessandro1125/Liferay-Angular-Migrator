Liferay.Loader.define('@example-angular-liferay$angular/platform-browser@6.1.10/esm2015/src/security/dom_sanitization_service', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  /** @nocollapse */
  DomSanitizerImpl.ctorParameters = () => [{ type: undefined, decorators: [{ type: Inject, args: [DOCUMENT] }] }];
  if (false) {
    /** @type {?} */
