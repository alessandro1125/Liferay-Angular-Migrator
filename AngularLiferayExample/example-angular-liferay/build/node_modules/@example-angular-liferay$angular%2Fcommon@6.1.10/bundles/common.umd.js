Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/bundles/common.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/core'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/core')) : typeof define === 'function' && define.amd ? define('@angular/common', ['exports', '@angular/core'], factory) : factory((global.ng = global.ng || {}, global.ng.common = {}), global.ng.core);
        ...
        ***************************************************************************** */
        ...
        var Location = /** @class */function () {
            ...
            var Location_1;
            Location = Location_1 = __decorate([core.Injectable(), __metadata("design:paramtypes", [LocationStrategy])], Location);
            return Location;
        }();
        ...
        var HashLocationStrategy = /** @class */function (_super) {
            ...
            HashLocationStrategy = __decorate([core.Injectable(), __param(1, core.Optional()), __param(1, core.Inject(APP_BASE_HREF)), __metadata("design:paramtypes", [PlatformLocation, String])], HashLocationStrategy);
        ...
        var PathLocationStrategy = /** @class */function (_super) {
            ...
            PathLocationStrategy = __decorate([core.Injectable(), __param(1, core.Optional()), __param(1, core.Inject(APP_BASE_HREF)), __metadata("design:paramtypes", [PlatformLocation, String])], PathLocationStrategy);
        ...
        function getNamedFormat(locale, format) {
            ...
            switch (format) {
                ...
                case 'long':
                    ...
                    formatValue = formatDateTime(getLocaleDateTimeFormat(locale, exports.FormatWidth.Long), [longTime, longDate]);
                    break;
                case 'full':
                    var fullTime = getNamedFormat(locale, 'fullTime');
                    var fullDate = getNamedFormat(locale, 'fullDate');
                    formatValue = formatDateTime(getLocaleDateTimeFormat(locale, exports.FormatWidth.Full), [fullTime, fullDate]);
                    break;
            }
            if (formatValue) {
        ...
        var NgLocaleLocalization = /** @class */function (_super) {
            ...
            NgLocaleLocalization = __decorate([core.Injectable(), __param(0, core.Inject(core.LOCALE_ID)), __param(1, core.Optional()), __param(1, core.Inject(DEPRECATED_PLURAL_FN)), __metadata("design:paramtypes", [String, Object])], NgLocaleLocalization);
        ...
        function getPluralCase(locale, nLike) {
            ...
            switch (lang) {
                ...
                case 'wae':
                case 'xog':
                    if (n === 1) return exports.Plural.One;
                ...
                case 'pa':
                case 'ti':
                    if (n === Math.floor(n) && n >= 0 && n <= 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'am':
                case 'as':
                case 'bn':
                ...
                case 'mr':
                case 'zu':
                    if (i === 0 || n === 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'ar':
                    if (n === 0) return exports.Plural.Zero;
                    if (n === 1) return exports.Plural.One;
                    if (n === 2) return exports.Plural.Two;
                    if (n % 100 === Math.floor(n % 100) && n % 100 >= 3 && n % 100 <= 10) return exports.Plural.Few;
                    if (n % 100 === Math.floor(n % 100) && n % 100 >= 11 && n % 100 <= 99) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'ast':
                case 'ca':
                case 'de':
                ...
                case 'ur':
                case 'yi':
                    if (i === 1 && v === 0) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'be':
                    if (n % 10 === 1 && !(n % 100 === 11)) return exports.Plural.One;
                    if (n % 10 === Math.floor(n % 10) && n % 10 >= 2 && n % 10 <= 4 && !(n % 100 >= 12 && n % 100 <= 14)) return exports.Plural.Few;
                    if (n % 10 === 0 || n % 10 === Math.floor(n % 10) && n % 10 >= 5 && n % 10 <= 9 || n % 100 === Math.floor(n % 100) && n % 100 >= 11 && n % 100 <= 14) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'br':
                    if (n % 10 === 1 && !(n % 100 === 11 || n % 100 === 71 || n % 100 === 91)) return exports.Plural.One;
                    if (n % 10 === 2 && !(n % 100 === 12 || n % 100 === 72 || n % 100 === 92)) return exports.Plural.Two;
                    if (n % 10 === Math.floor(n % 10) && (n % 10 >= 3 && n % 10 <= 4 || n % 10 === 9) && !(n % 100 >= 10 && n % 100 <= 19 || n % 100 >= 70 && n % 100 <= 79 || n % 100 >= 90 && n % 100 <= 99)) return exports.Plural.Few;
                    if (!(n === 0) && n % 1e6 === 0) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'bs':
                case 'hr':
                case 'sr':
                    if (v === 0 && i % 10 === 1 && !(i % 100 === 11) || f % 10 === 1 && !(f % 100 === 11)) return exports.Plural.One;
                    if (v === 0 && i % 10 === Math.floor(i % 10) && i % 10 >= 2 && i % 10 <= 4 && !(i % 100 >= 12 && i % 100 <= 14) || f % 10 === Math.floor(f % 10) && f % 10 >= 2 && f % 10 <= 4 && !(f % 100 >= 12 && f % 100 <= 14)) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'cs':
                case 'sk':
                    if (i === 1 && v === 0) return exports.Plural.One;
                    if (i === Math.floor(i) && i >= 2 && i <= 4 && v === 0) return exports.Plural.Few;
                    if (!(v === 0)) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'cy':
                    if (n === 0) return exports.Plural.Zero;
                    if (n === 1) return exports.Plural.One;
                    if (n === 2) return exports.Plural.Two;
                    if (n === 3) return exports.Plural.Few;
                    if (n === 6) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'da':
                    if (n === 1 || !(t === 0) && (i === 0 || i === 1)) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'dsb':
                case 'hsb':
                    if (v === 0 && i % 100 === 1 || f % 100 === 1) return exports.Plural.One;
                    if (v === 0 && i % 100 === 2 || f % 100 === 2) return exports.Plural.Two;
                    if (v === 0 && i % 100 === Math.floor(i % 100) && i % 100 >= 3 && i % 100 <= 4 || f % 100 === Math.floor(f % 100) && f % 100 >= 3 && f % 100 <= 4) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'ff':
                case 'fr':
                case 'hy':
                case 'kab':
                    if (i === 0 || i === 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'fil':
                    if (v === 0 && (i === 1 || i === 2 || i === 3) || v === 0 && !(i % 10 === 4 || i % 10 === 6 || i % 10 === 9) || !(v === 0) && !(f % 10 === 4 || f % 10 === 6 || f % 10 === 9)) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'ga':
                    if (n === 1) return exports.Plural.One;
                    if (n === 2) return exports.Plural.Two;
                    if (n === Math.floor(n) && n >= 3 && n <= 6) return exports.Plural.Few;
                    if (n === Math.floor(n) && n >= 7 && n <= 10) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'gd':
                    if (n === 1 || n === 11) return exports.Plural.One;
                    if (n === 2 || n === 12) return exports.Plural.Two;
                    if (n === Math.floor(n) && (n >= 3 && n <= 10 || n >= 13 && n <= 19)) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'gv':
                    if (v === 0 && i % 10 === 1) return exports.Plural.One;
                    if (v === 0 && i % 10 === 2) return exports.Plural.Two;
                    if (v === 0 && (i % 100 === 0 || i % 100 === 20 || i % 100 === 40 || i % 100 === 60 || i % 100 === 80)) return exports.Plural.Few;
                    if (!(v === 0)) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'he':
                    if (i === 1 && v === 0) return exports.Plural.One;
                    if (i === 2 && v === 0) return exports.Plural.Two;
                    if (v === 0 && !(n >= 0 && n <= 10) && n % 10 === 0) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'is':
                    if (t === 0 && i % 10 === 1 && !(i % 100 === 11) || !(t === 0)) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'ksh':
                    if (n === 0) return exports.Plural.Zero;
                    if (n === 1) return exports.Plural.One;
                ...
                case 'lag':
                    if (n === 0) return exports.Plural.Zero;
                    if ((i === 0 || i === 1) && !(n === 0)) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'lt':
                    if (n % 10 === 1 && !(n % 100 >= 11 && n % 100 <= 19)) return exports.Plural.One;
                    if (n % 10 === Math.floor(n % 10) && n % 10 >= 2 && n % 10 <= 9 && !(n % 100 >= 11 && n % 100 <= 19)) return exports.Plural.Few;
                    if (!(f === 0)) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'lv':
                case 'prg':
                    if (n % 10 === 0 || n % 100 === Math.floor(n % 100) && n % 100 >= 11 && n % 100 <= 19 || v === 2 && f % 100 === Math.floor(f % 100) && f % 100 >= 11 && f % 100 <= 19) return exports.Plural.Zero;
                    if (n % 10 === 1 && !(n % 100 === 11) || v === 2 && f % 10 === 1 && !(f % 100 === 11) || !(v === 2) && f % 10 === 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'mk':
                    if (v === 0 && i % 10 === 1 || f % 10 === 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'mt':
                    if (n === 1) return exports.Plural.One;
                    if (n === 0 || n % 100 === Math.floor(n % 100) && n % 100 >= 2 && n % 100 <= 10) return exports.Plural.Few;
                    if (n % 100 === Math.floor(n % 100) && n % 100 >= 11 && n % 100 <= 19) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'pl':
                    if (i === 1 && v === 0) return exports.Plural.One;
                    if (v === 0 && i % 10 === Math.floor(i % 10) && i % 10 >= 2 && i % 10 <= 4 && !(i % 100 >= 12 && i % 100 <= 14)) return exports.Plural.Few;
                    if (v === 0 && !(i === 1) && i % 10 === Math.floor(i % 10) && i % 10 >= 0 && i % 10 <= 1 || v === 0 && i % 10 === Math.floor(i % 10) && i % 10 >= 5 && i % 10 <= 9 || v === 0 && i % 100 === Math.floor(i % 100) && i % 100 >= 12 && i % 100 <= 14) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'pt':
                    if (n === Math.floor(n) && n >= 0 && n <= 2 && !(n === 2)) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'ro':
                    if (i === 1 && v === 0) return exports.Plural.One;
                    if (!(v === 0) || n === 0 || !(n === 1) && n % 100 === Math.floor(n % 100) && n % 100 >= 1 && n % 100 <= 19) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'ru':
                case 'uk':
                    if (v === 0 && i % 10 === 1 && !(i % 100 === 11)) return exports.Plural.One;
                    if (v === 0 && i % 10 === Math.floor(i % 10) && i % 10 >= 2 && i % 10 <= 4 && !(i % 100 >= 12 && i % 100 <= 14)) return exports.Plural.Few;
                    if (v === 0 && i % 10 === 0 || v === 0 && i % 10 === Math.floor(i % 10) && i % 10 >= 5 && i % 10 <= 9 || v === 0 && i % 100 === Math.floor(i % 100) && i % 100 >= 11 && i % 100 <= 14) return exports.Plural.Many;
                    return exports.Plural.Other;
                case 'shi':
                    if (i === 0 || n === 1) return exports.Plural.One;
                    if (n === Math.floor(n) && n >= 2 && n <= 10) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'si':
                    if (n === 0 || n === 1 || i === 0 && f === 1) return exports.Plural.One;
                    return exports.Plural.Other;
                case 'sl':
                    if (v === 0 && i % 100 === 1) return exports.Plural.One;
                    if (v === 0 && i % 100 === 2) return exports.Plural.Two;
                    if (v === 0 && i % 100 === Math.floor(i % 100) && i % 100 >= 3 && i % 100 <= 4 || !(v === 0)) return exports.Plural.Few;
                    return exports.Plural.Other;
                case 'tzm':
                    if (n === Math.floor(n) && n >= 0 && n <= 1 || n === Math.floor(n) && n >= 11 && n <= 99) return exports.Plural.One;
                    return exports.Plural.Other;
        ...
        var NgClass = /** @class */function () {
            ...
            __decorate([core.Input('class'), __metadata("design:type", String), __metadata("design:paramtypes", [String])], NgClass.prototype, "klass", null);
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgClass.prototype, "ngClass", null);
            NgClass = __decorate([core.Directive({ selector: '[ngClass]' }), __metadata("design:paramtypes", [core.IterableDiffers, core.KeyValueDiffers, core.ElementRef, core.Renderer2])], NgClass);
            return NgClass;
        }();
        ...
        var NgComponentOutlet = /** @class */function () {
            ...
            NgComponentOutlet.prototype.ngOnChanges = function (changes) {
                ...
                if (this.ngComponentOutlet) {
                    ...
                    var componentFactoryResolver = this._moduleRef ? this._moduleRef.componentFactoryResolver : elInjector.get(core.ComponentFactoryResolver);
            ...
            __decorate([core.Input(), __metadata("design:type", core.Type)], NgComponentOutlet.prototype, "ngComponentOutlet", void 0);
            __decorate([core.Input(), __metadata("design:type", core.Injector)], NgComponentOutlet.prototype, "ngComponentOutletInjector", void 0);
            __decorate([core.Input(), __metadata("design:type", Array)], NgComponentOutlet.prototype, "ngComponentOutletContent", void 0);
            __decorate([core.Input(), __metadata("design:type", core.NgModuleFactory)], NgComponentOutlet.prototype, "ngComponentOutletNgModuleFactory", void 0);
            NgComponentOutlet = __decorate([core.Directive({ selector: '[ngComponentOutlet]' }), __metadata("design:paramtypes", [core.ViewContainerRef])], NgComponentOutlet);
        ...
        var NgForOf = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgForOf.prototype, "ngForOf", null);
            __decorate([core.Input(), __metadata("design:type", Function), __metadata("design:paramtypes", [Function])], NgForOf.prototype, "ngForTrackBy", null);
            __decorate([core.Input(), __metadata("design:type", core.TemplateRef), __metadata("design:paramtypes", [core.TemplateRef])], NgForOf.prototype, "ngForTemplate", null);
            NgForOf = __decorate([core.Directive({ selector: '[ngFor][ngForOf]' }), __metadata("design:paramtypes", [core.ViewContainerRef, core.TemplateRef, core.IterableDiffers])], NgForOf);
            return NgForOf;
        }();
        ...
        var NgIf = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgIf.prototype, "ngIf", null);
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgIf.prototype, "ngIfThen", null);
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgIf.prototype, "ngIfElse", null);
            NgIf = __decorate([core.Directive({ selector: '[ngIf]' }), __metadata("design:paramtypes", [core.ViewContainerRef, core.TemplateRef])], NgIf);
            return NgIf;
        }();
        ...
        var NgSwitch = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgSwitch.prototype, "ngSwitch", null);
            NgSwitch = __decorate([core.Directive({ selector: '[ngSwitch]' })], NgSwitch);
            return NgSwitch;
        }();
        /**
         * @ngModule CommonModule
        ...
        var NgSwitchCase = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Object)], NgSwitchCase.prototype, "ngSwitchCase", void 0);
            NgSwitchCase = __decorate([core.Directive({ selector: '[ngSwitchCase]' }), __param(2, core.Host()), __metadata("design:paramtypes", [core.ViewContainerRef, core.TemplateRef, NgSwitch])], NgSwitchCase);
            return NgSwitchCase;
        }();
        /**
         * @ngModule CommonModule
        ...
        var NgSwitchDefault = /** @class */function () {
            ...
            NgSwitchDefault = __decorate([core.Directive({ selector: '[ngSwitchDefault]' }), __param(2, core.Host()), __metadata("design:paramtypes", [core.ViewContainerRef, core.TemplateRef, NgSwitch])], NgSwitchDefault);
        ...
        var NgPlural = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Number), __metadata("design:paramtypes", [Number])], NgPlural.prototype, "ngPlural", null);
            NgPlural = __decorate([core.Directive({ selector: '[ngPlural]' }), __metadata("design:paramtypes", [NgLocalization])], NgPlural);
            return NgPlural;
        }();
        /**
         * @ngModule CommonModule
        ...
        var NgPluralCase = /** @class */function () {
            ...
            NgPluralCase = __decorate([core.Directive({ selector: '[ngPluralCase]' }), __param(0, core.Attribute('ngPluralCase')), __param(3, core.Host()), __metadata("design:paramtypes", [String, core.TemplateRef, core.ViewContainerRef, NgPlural])], NgPluralCase);
            return NgPluralCase;
        }();
        ...
        var NgStyle = /** @class */function () {
            ...
            NgStyle.prototype._setStyle = function (nameAndUnit, value) {
                var _a = __read(nameAndUnit.split('.'), 2),
                    name = _a[0],
                    unit = _a[1];
            ...
            __decorate([core.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], NgStyle.prototype, "ngStyle", null);
            NgStyle = __decorate([core.Directive({ selector: '[ngStyle]' }), __metadata("design:paramtypes", [core.KeyValueDiffers, core.ElementRef, core.Renderer2])], NgStyle);
            return NgStyle;
        }();
        ...
        var NgTemplateOutlet = /** @class */function () {
            ...
            __decorate([core.Input(), __metadata("design:type", Object)], NgTemplateOutlet.prototype, "ngTemplateOutletContext", void 0);
            __decorate([core.Input(), __metadata("design:type", core.TemplateRef)], NgTemplateOutlet.prototype, "ngTemplateOutlet", void 0);
            NgTemplateOutlet = __decorate([core.Directive({ selector: '[ngTemplateOutlet]' }), __metadata("design:paramtypes", [core.ViewContainerRef])], NgTemplateOutlet);
        ...
        * found in the LICENSE file at https://angular.io/license
        ...
        var DeprecatedDatePipe = /** @class */function () {
            ...
            DeprecatedDatePipe = DeprecatedDatePipe_1 = __decorate([core.Pipe({ name: 'date', pure: true }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DeprecatedDatePipe);
        ...
        var DeprecatedDecimalPipe = /** @class */function () {
            ...
            DeprecatedDecimalPipe = DeprecatedDecimalPipe_1 = __decorate([core.Pipe({ name: 'number' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DeprecatedDecimalPipe);
        ...
        var DeprecatedPercentPipe = /** @class */function () {
            ...
            DeprecatedPercentPipe = DeprecatedPercentPipe_1 = __decorate([core.Pipe({ name: 'percent' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DeprecatedPercentPipe);
        ...
        var DeprecatedCurrencyPipe = /** @class */function () {
            ...
            DeprecatedCurrencyPipe = DeprecatedCurrencyPipe_1 = __decorate([core.Pipe({ name: 'currency' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DeprecatedCurrencyPipe);
        ...
        var AsyncPipe = /** @class */function () {
            ...
            var AsyncPipe_1;
            AsyncPipe = AsyncPipe_1 = __decorate([core.Pipe({ name: 'async', pure: false }), __metadata("design:paramtypes", [core.ChangeDetectorRef])], AsyncPipe);
            return AsyncPipe;
        }();
        ...
        var LowerCasePipe = /** @class */function () {
            ...
            var LowerCasePipe_1;
            LowerCasePipe = LowerCasePipe_1 = __decorate([core.Pipe({ name: 'lowercase' })], LowerCasePipe);
        ...
        var TitleCasePipe = /** @class */function () {
            ...
            var TitleCasePipe_1;
            TitleCasePipe = TitleCasePipe_1 = __decorate([core.Pipe({ name: 'titlecase' })], TitleCasePipe);
        ...
        var UpperCasePipe = /** @class */function () {
            ...
            var UpperCasePipe_1;
            UpperCasePipe = UpperCasePipe_1 = __decorate([core.Pipe({ name: 'uppercase' })], UpperCasePipe);
        ...
        var DatePipe = /** @class */function () {
            ...
            var DatePipe_1;
            DatePipe = DatePipe_1 = __decorate([core.Pipe({ name: 'date', pure: true }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DatePipe);
            return DatePipe;
        }();
        ...
        var I18nPluralPipe = /** @class */function () {
            ...
            I18nPluralPipe = I18nPluralPipe_1 = __decorate([core.Pipe({ name: 'i18nPlural', pure: true }), __metadata("design:paramtypes", [NgLocalization])], I18nPluralPipe);
        ...
        var I18nSelectPipe = /** @class */function () {
            ...
            I18nSelectPipe = I18nSelectPipe_1 = __decorate([core.Pipe({ name: 'i18nSelect', pure: true })], I18nSelectPipe);
        ...
        var JsonPipe = /** @class */function () {
            ...
            JsonPipe = __decorate([core.Pipe({ name: 'json', pure: false })], JsonPipe);
            return JsonPipe;
        }();
        ...
        var KeyValuePipe = /** @class */function () {
            ...
            KeyValuePipe = __decorate([core.Pipe({ name: 'keyvalue', pure: false }), __metadata("design:paramtypes", [core.KeyValueDiffers])], KeyValuePipe);
            return KeyValuePipe;
        }();
        ...
        var DecimalPipe = /** @class */function () {
            ...
            var DecimalPipe_1;
            DecimalPipe = DecimalPipe_1 = __decorate([core.Pipe({ name: 'number' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], DecimalPipe);
            return DecimalPipe;
        }();
        /**
         * @ngModule CommonModule
        ...
        var PercentPipe = /** @class */function () {
            ...
            var PercentPipe_1;
            PercentPipe = PercentPipe_1 = __decorate([core.Pipe({ name: 'percent' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], PercentPipe);
            return PercentPipe;
        }();
        /**
         * @ngModule CommonModule
        ...
        var CurrencyPipe = /** @class */function () {
            ...
            var CurrencyPipe_1;
            CurrencyPipe = CurrencyPipe_1 = __decorate([core.Pipe({ name: 'currency' }), __param(0, core.Inject(core.LOCALE_ID)), __metadata("design:paramtypes", [String])], CurrencyPipe);
            return CurrencyPipe;
        }();
        ...
        var SlicePipe = /** @class */function () {
            ...
            var SlicePipe_1;
            SlicePipe = SlicePipe_1 = __decorate([core.Pipe({ name: 'slice', pure: false })], SlicePipe);
            return SlicePipe;
        }();
        ...
        var CommonModule = /** @class */function () {
            ...
            CommonModule = __decorate([core.NgModule({
        ...
        var DeprecatedI18NPipesModule = /** @class */function () {
            ...
            DeprecatedI18NPipesModule = __decorate([core.NgModule({
        ...
        var ViewportScroller = /** @class */function () {
            ...
            // See #23917
            /** @nocollapse */
            ViewportScroller.ngInjectableDef = core.defineInjectable({ providedIn: 'root', factory: function () {
                    return new BrowserViewportScroller(core.inject(DOCUMENT), window);
                } });
