Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/bundles/common-http.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/core', 'example-angular-liferay$rxjs', 'example-angular-liferay$rxjs/operators', '@example-angular-liferay$angular/common'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/core'), require('example-angular-liferay$rxjs'), require('example-angular-liferay$rxjs/operators'), require('@example-angular-liferay$angular/common')) : typeof define === 'function' && define.amd ? define('@angular/common/http', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) : factory((global.ng = global.ng || {}, global.ng.common = global.ng.common || {}, global.ng.common.http = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common);
        ...
        ***************************************************************************** */
        ...
        function paramParser(rawParams, codec) {
            ...
            if (rawParams.length > 0) {
                ...
                params.forEach(function (param) {
                    ...
                    var _a = __read(eqIdx == -1 ? [codec.decodeKey(param), ''] : [codec.decodeKey(param.slice(0, eqIdx)), codec.decodeValue(param.slice(eqIdx + 1))], 2),
                        key = _a[0],
                        val = _a[1];
        ...
        var HttpClient = /** @class */function () {
            ...
            HttpClient = __decorate([core.Injectable(), __metadata("design:paramtypes", [HttpHandler])], HttpClient);
            return HttpClient;
        }();
        ...
        var NoopInterceptor = /** @class */function () {
            ...
            NoopInterceptor = __decorate([core.Injectable()], NoopInterceptor);
        ...
        var JsonpClientBackend = /** @class */function () {
            ...
            JsonpClientBackend = __decorate([core.Injectable(), __param(1, core.Inject(common.DOCUMENT)), __metadata("design:paramtypes", [JsonpCallbackContext, Object])], JsonpClientBackend);
        ...
        var JsonpInterceptor = /** @class */function () {
            ...
            JsonpInterceptor = __decorate([core.Injectable(), __metadata("design:paramtypes", [JsonpClientBackend])], JsonpInterceptor);
        ...
        var BrowserXhr = /** @class */function () {
            ...
            BrowserXhr = __decorate([core.Injectable(), __metadata("design:paramtypes", [])], BrowserXhr);
            return BrowserXhr;
        }();
        /**
        ...
        var HttpXhrBackend = /** @class */function () {
            ...
            HttpXhrBackend = __decorate([core.Injectable(), __metadata("design:paramtypes", [XhrFactory])], HttpXhrBackend);
        ...
        var HttpXsrfCookieExtractor = /** @class */function () {
            ...
            HttpXsrfCookieExtractor = __decorate([core.Injectable(), __param(0, core.Inject(common.DOCUMENT)), __param(1, core.Inject(core.PLATFORM_ID)), __param(2, core.Inject(XSRF_COOKIE_NAME)), __metadata("design:paramtypes", [Object, String, String])], HttpXsrfCookieExtractor);
        ...
        var HttpXsrfInterceptor = /** @class */function () {
            ...
            HttpXsrfInterceptor = __decorate([core.Injectable(), __param(1, core.Inject(XSRF_HEADER_NAME)), __metadata("design:paramtypes", [HttpXsrfTokenExtractor, String])], HttpXsrfInterceptor);
        ...
        var HttpInterceptingHandler = /** @class */function () {
            ...
            HttpInterceptingHandler = __decorate([core.Injectable(), __metadata("design:paramtypes", [HttpBackend, core.Injector])], HttpInterceptingHandler);
        ...
        var HttpClientXsrfModule = /** @class */function () {
            ...
            HttpClientXsrfModule = HttpClientXsrfModule_1 = __decorate([core.NgModule({
        ...
        var HttpClientModule = /** @class */function () {
            ...
            HttpClientModule = __decorate([core.NgModule({
                /**
        ...
        var HttpClientJsonpModule = /** @class */function () {
            ...
            HttpClientJsonpModule = __decorate([core.NgModule({
