Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/fesm5/http/testing', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var HttpClientTestingBackend = /** @class */function () {
        ...
        HttpClientTestingBackend = __decorate([Injectable()], HttpClientTestingBackend);
    ...
    var HttpClientTestingModule = /** @class */function () {
        ...
        HttpClientTestingModule = __decorate([NgModule({
            imports: [HttpClientModule],
            providers: [HttpClientTestingBackend, { provide: HttpBackend, useExisting: HttpClientTestingBackend }, { provide: HttpTestingController, useExisting: HttpClientTestingBackend }]
