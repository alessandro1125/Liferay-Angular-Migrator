Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/esm5/src/i18n/localization', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var NgLocaleLocalization = /** @class */function (_super) {
        ...
        NgLocaleLocalization = tslib_1.__decorate([Injectable(), tslib_1.__param(0, Inject(LOCALE_ID)), tslib_1.__param(1, Optional()), tslib_1.__param(1, Inject(DEPRECATED_PLURAL_FN)), tslib_1.__metadata("design:paramtypes", [String, Object])], NgLocaleLocalization);
