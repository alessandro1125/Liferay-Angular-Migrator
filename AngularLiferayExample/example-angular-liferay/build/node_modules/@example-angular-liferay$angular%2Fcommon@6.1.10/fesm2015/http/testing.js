Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/fesm2015/http/testing', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    HttpClientTestingBackend.decorators = [{ type: Injectable }];
    ...
    HttpClientTestingModule.decorators = [{ type: NgModule, args: [{
