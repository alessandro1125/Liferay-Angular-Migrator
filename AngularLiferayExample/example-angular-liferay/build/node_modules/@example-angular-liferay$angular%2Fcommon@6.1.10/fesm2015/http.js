Liferay.Loader.define('@example-angular-liferay$angular/common@6.1.10/fesm2015/http', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    class HttpHeaders {
        ...
        forEach(fn) {
            this.init();
            Array.from(this.normalizedNames.keys()).forEach(key => fn( /** @type {?} */this.normalizedNames.get(key), /** @type {?} */this.headers.get(key)));
        }
    }
    ...
    class HttpRequest {
        ...
        clone(update = {}) {
            ...
            if (update.setHeaders !== undefined) {
                ...
                headers = Object.keys(update.setHeaders).reduce((headers, name) => headers.set(name, /** @type {?} */update.setHeaders[name]), headers);
            }
            // Check whether the caller has asked to set params.
            if (update.setParams) {
                // Set every requested param.
                params = Object.keys(update.setParams).reduce((params, param) => params.set(param, /** @type {?} */update.setParams[param]), params);
            }
    ...
    HttpClient.decorators = [{ type: Injectable }];
    /** @nocollapse */
    ...
    NoopInterceptor.decorators = [{ type: Injectable }];
    ...
    JsonpClientBackend.decorators = [{ type: Injectable }];
    /** @nocollapse */
    JsonpClientBackend.ctorParameters = () => [{ type: JsonpCallbackContext }, { type: undefined, decorators: [{ type: Inject, args: [DOCUMENT] }] }];
    /**
    ...
    JsonpInterceptor.decorators = [{ type: Injectable }];
    /** @nocollapse */
    ...
    HttpXhrBackend.decorators = [{ type: Injectable }];
    /** @nocollapse */
    ...
    HttpXsrfCookieExtractor.decorators = [{ type: Injectable }];
    /** @nocollapse */
    HttpXsrfCookieExtractor.ctorParameters = () => [{ type: undefined, decorators: [{ type: Inject, args: [DOCUMENT] }] }, { type: String, decorators: [{ type: Inject, args: [PLATFORM_ID] }] }, { type: String, decorators: [{ type: Inject, args: [XSRF_COOKIE_NAME] }] }];
    /**
    ...
    HttpXsrfInterceptor.decorators = [{ type: Injectable }];
    /** @nocollapse */
    HttpXsrfInterceptor.ctorParameters = () => [{ type: HttpXsrfTokenExtractor }, { type: String, decorators: [{ type: Inject, args: [XSRF_HEADER_NAME] }] }];
    ...
    HttpInterceptingHandler.decorators = [{ type: Injectable }];
    /** @nocollapse */
    ...
    HttpClientXsrfModule.decorators = [{ type: NgModule, args: [{
    ...
    HttpClientModule.decorators = [{ type: NgModule, args: [{
            /**
    ...
    HttpClientJsonpModule.decorators = [{ type: NgModule, args: [{
