Liferay.Loader.define('example-angular-liferay$core-js@2.6.5/build/index', ['module', 'exports', 'require', '../library/fn/promise', './config', 'example-angular-liferay$fs', 'example-angular-liferay$path', 'example-angular-liferay$webpack', 'example-angular-liferay$temp'], function (module, exports, require) {
  ...
  (function () {
    ...
    ref$ = require('example-angular-liferay$fs'), readFile = ref$.readFile, writeFile = ref$.writeFile, unlink = ref$.unlink;
    ref$ = require('example-angular-liferay$path'), basename = ref$.basename, dirname = ref$.dirname, join = ref$.join;
    webpack = require('example-angular-liferay$webpack');
    temp = require('example-angular-liferay$temp');
