...
Liferay.Loader.define("example-angular-liferay$rxjs@6.4.0/_esm2015/path-mapping", ['module', 'exports', 'require', 'example-angular-liferay$path'], function (module, exports, require) {
  var define = undefined;
  var path = require("example-angular-liferay$path");
