Liferay.Loader.define('@example-angular-liferay$angular/animations@6.1.10/bundles/animations-browser.umd', ['module', 'exports', 'require', '@example-angular-liferay$angular/animations', '@example-angular-liferay$angular/core'], function (module, exports, require) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@example-angular-liferay$angular/animations'), require('@example-angular-liferay$angular/core')) : typeof define === 'function' && define.amd ? define('@angular/animations/browser', ['exports', '@angular/animations', '@angular/core'], factory) : factory((global.ng = global.ng || {}, global.ng.animations = global.ng.animations || {}, global.ng.animations.browser = {}), global.ng.animations, global.ng.core);
        ...
        ***************************************************************************** */
        ...
        var AnimationAstBuilderVisitor = /** @class */function () {
            ...
            AnimationAstBuilderVisitor.prototype.visitStagger = function (metadata, context) {
                ...
                var timings = metadata.timings === 'full' ? { duration: 0, delay: 0, easing: 'full' } : resolveTiming(metadata.timings, context.errors, true);
                return {
                    type: 12 /* Stagger */
            ...
            TimelineBuilder.prototype.setStyles = function (input, easing, errors, options) {
                ...
                Object.keys(styles).forEach(function (prop) {
                    ...
                    if (!_this._localTimelineStyles.hasOwnProperty(prop)) {
                        _this._backFill[prop] = _this._globalTimelineStyles.hasOwnProperty(prop) ? _this._globalTimelineStyles[prop] : animations.AUTO_STYLE;
                    }
        ...
        var TransitionAnimationEngine = /** @class */function () {
            ...
            TransitionAnimationEngine.prototype._buildAnimation = function (namespaceId, instruction, allPreviousPlayersMap, skippedPlayersMap, preStylesMap, postStylesMap) {
                ...
                var allNewPlayers = instruction.timelines.map(function (timelineInstruction) {
                    ...
                    var details = element[REMOVAL_FLAG];
                    if (details && details.removedBeforeQueried) return new animations.NoopAnimationPlayer(timelineInstruction.duration, timelineInstruction.delay);
                    var isQueriedElement = element !== rootElement;
