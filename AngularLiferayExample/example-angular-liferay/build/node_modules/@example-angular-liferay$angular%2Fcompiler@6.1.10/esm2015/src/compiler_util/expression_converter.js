Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/compiler_util/expression_converter', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    class _AstToIrVisitor {
        ...
        visitInterpolation(ast, mode) {
            ...
            return ast.expressions.length <= 9 ? o.importExpr(Identifiers.inlineInterpolate).callFn(args) : o.importExpr(Identifiers.interpolate).callFn([args[0], o.literalArr(args.slice(1))]);
        }
        ...
        visitLiteralPrimitive(ast, mode) {
            ...
            // to infer the type.
            const type = ast.value === null || ast.value === undefined || ast.value === true || ast.value === true ? o.INFERRED_TYPE : undefined;
