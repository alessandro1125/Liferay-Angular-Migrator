Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/constant_pool', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class ConstantPool {
        ...
        _getLiteralFactory(key, values, resultMap) {
            ...
            if (!literalFactory) {
                ...
                const name = this.freshName();
                this.statements.push(o.variable(name).set(pureFunctionDeclaration).toDeclStmt(o.INFERRED_TYPE, [o.StmtModifier.Final]));
