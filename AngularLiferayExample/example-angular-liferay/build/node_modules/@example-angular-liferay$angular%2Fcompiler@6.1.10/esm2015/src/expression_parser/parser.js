Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/expression_parser/parser', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class Parser {
        ...
        parseAction(input, location, interpolationConfig = DEFAULT_INTERPOLATION_CONFIG) {
            ...
            const ast = new _ParseAST(input, location, tokens, sourceToLex.length, true, this.errors, input.length - sourceToLex.length).parseChain();
        ...
        parseTemplateBindings(tplKey, tplValue, location) {
            ...
            return new _ParseAST(tplValue, location, tokens, tplValue.length, false, this.errors, 0).parseTemplateBindings(tplKey);
        }
        parseInterpolation(input, location, interpolationConfig = DEFAULT_INTERPOLATION_CONFIG) {
            ...
            for (let i = 0; i < split.expressions.length; ++i) {
                ...
                const tokens = this._lexer.tokenize(sourceToLex);
                const ast = new _ParseAST(input, location, tokens, sourceToLex.length, false, this.errors, split.offsets[i] + (expressionText.length - sourceToLex.length)).parseChain();
