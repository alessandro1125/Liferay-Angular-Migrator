Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/view_compiler/type_check_compiler', ['module', 'exports', 'require'], function (module, exports, require) {
            ...
            return {
                ...
                value: convertPropertyBindingBuiltins({
                    ...
                    createPipeConverter: (name, argCount) => args => {
                        // Note: The old view compiler used to use an `any` type
                        // for pipes.
                        const pipeExpr = this.options.fullTemplateTypeCheck ? o.variable(this.pipeOutputVar(name)) : o.variable(this.getOutputVar(o.BuiltinTypeName.Dynamic));
