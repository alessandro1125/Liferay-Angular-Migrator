Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/aot/static_reflector', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    function formatMetadataMessageChain(chain, advise) {
        ...
        const next = chain.next ? formatMetadataMessageChain(chain.next, advise) : advise ? { message: advise } : undefined;
