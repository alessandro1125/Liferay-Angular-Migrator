Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/aot/summary_serializer', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    class ToJsonSerializer extends ValueTransformer {
        ...
        visitStaticSymbol(baseSymbol, flags) {
            ...
            let summary = null;
            if (flags & 1 /* ResolveValue */ && this.summaryResolver.isLibraryFile(baseSymbol.filePath)) {
    ...
    class ForJitSerializer {
        ...
        serialize(exportAsArr) {
            ...
            ngModuleSymbols.forEach(ngModuleSymbol => {
                if (this.summaryResolver.isLibraryFile(ngModuleSymbol.filePath)) {
                    ...
                    this.outputCtx.statements.push(o.variable(jitExportAsName).set(this.serializeSummaryRef(ngModuleSymbol)).toDeclStmt(null, [o.StmtModifier.Exported]));
                }
            });
        }
        serializeSummaryWithDeps(summary, metadata) {
            ...
            if (metadata instanceof CompileNgModuleMetadata) {
                ...
                // summaries.
                metadata.declaredDirectives.concat(metadata.declaredPipes).map(type => type.reference)
                // For modules,
                // we also add the summaries for modules
                // from libraries.
                // This is ok as we produce reexports for all transitive modules.
                .concat(metadata.transitiveModule.modules.map(type => type.reference).filter(ref => ref !== metadata.type.reference)).map(ref => this.serializeSummaryRef(ref)));
