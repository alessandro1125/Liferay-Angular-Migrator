Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/directive_normalizer', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class DirectiveNormalizer {
        ...
        _preparseLoadedTemplate(prenormData, template, templateAbsUrl) {
            ...
            const styleUrls = this._normalizeStylesheet(new CompileStylesheetMetadata({ styleUrls: prenormData.styleUrls, moduleUrl: prenormData.moduleUrl })).styleUrls;
            return {
                template,
