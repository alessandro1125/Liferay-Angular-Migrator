Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/style_compiler', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class StyleCompiler {
        ...
        _compileStyles(outputCtx, comp, stylesheet, shim, isComponentStylesheet) {
            ...
            const stmt = o.variable(stylesVar).set(o.literalArr(styleExpressions, new o.ArrayType(o.DYNAMIC_TYPE, [o.TypeModifier.Const]))).toDeclStmt(null, isComponentStylesheet ? [o.StmtModifier.Final] : [o.StmtModifier.Final, o.StmtModifier.Exported]);
