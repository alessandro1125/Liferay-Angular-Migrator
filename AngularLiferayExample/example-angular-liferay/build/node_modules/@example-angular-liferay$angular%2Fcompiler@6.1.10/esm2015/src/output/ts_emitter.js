Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/output/ts_emitter', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    class _TsEmitterVisitor extends AbstractEmitterVisitor {
        ...
        visitTryCatchStmt(stmt, ctx) {
            ...
            ctx.incIndent();
            const catchStmts = [CATCH_STACK_VAR.set(CATCH_ERROR_VAR.prop('stack', null)).toDeclStmt(null, [o.StmtModifier.Final])].concat(stmt.catchStmts);
