Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/template_parser/template_parser', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class TemplateParser {
        ...
        tryParse(component, template, directives, pipes, schemas, templateUrl, preserveWhitespaces) {
            let htmlParseResult = typeof template === 'string' ? this._htmlParser.parse(template, templateUrl, true, this.getInterpolationConfig(component)) : template;
    ...
    class TemplateParseVisitor {
        ...
        _checkPropertiesInSchema(elementName, boundProps) {
            ...
            return boundProps.filter(boundProp => {
                if (boundProp.type === 0 /* Property */ && !this._schemaRegistry.hasProperty(elementName, boundProp.name, this._schemas)) {
