Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm2015/src/template_parser/binding_parser', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export class BindingParser {
        ...
        _parseBinding(value, isHostBinding, sourceSpan) {
            ...
            try {
                const ast = isHostBinding ? this._exprParser.parseSimpleBinding(value, sourceInfo, this._interpolationConfig) : this._exprParser.parseBinding(value, sourceInfo, this._interpolationConfig);
                if (ast) this._reportExpressionParserErrors(ast.errors, sourceSpan);
                this._checkPipes(ast, sourceSpan);
                return ast;
            } catch (e) {
