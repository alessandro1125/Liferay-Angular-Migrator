Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/directive_normalizer', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var DirectiveNormalizer = /** @class */function () {
        ...
        DirectiveNormalizer.prototype._preparseLoadedTemplate = function (prenormData, template, templateAbsUrl) {
            ...
            var styleUrls = this._normalizeStylesheet(new CompileStylesheetMetadata({ styleUrls: prenormData.styleUrls, moduleUrl: prenormData.moduleUrl })).styleUrls;
            return {
                template: template,
