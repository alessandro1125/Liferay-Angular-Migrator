Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/output/ts_emitter', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var _TsEmitterVisitor = /** @class */function (_super) {
        ...
        _TsEmitterVisitor.prototype.visitTryCatchStmt = function (stmt, ctx) {
            ...
            ctx.incIndent();
            var catchStmts = [CATCH_STACK_VAR.set(CATCH_ERROR_VAR.prop('stack', null)).toDeclStmt(null, [o.StmtModifier.Final])].concat(stmt.catchStmts);
