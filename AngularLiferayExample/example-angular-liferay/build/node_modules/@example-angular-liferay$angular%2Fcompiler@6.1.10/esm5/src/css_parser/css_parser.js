Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/css_parser/css_parser', ['module', 'exports', 'require'], function (module, exports, require) {
            ...
            switch (this._scanner.peek) {
                ...
                default:
                    ...
                    if (this._scanner.peek != chars.$COLON) {
                        ...
                        endToken = prop = new CssToken(prop.index, prop.column, prop.line, prop.type, propStr_1.join(' '));
                    }
