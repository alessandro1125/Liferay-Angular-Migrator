Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/view_compiler/view_compiler', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var ViewBuilder = /** @class */function () {
        ...
        ViewBuilder.prototype.visitBoundText = function (ast, context) {
            ...
            this.nodes[nodeIndex] = function () {
                return {
                    sourceSpan: ast.sourceSpan,
                    nodeFlags: 2 /* TypeText */
                    , nodeDef: o.importExpr(Identifiers.textDef).callFn([o.literal(checkIndex), o.literal(ast.ngContentIndex), o.literalArr(inter.strings.map(function (s) {
                        return o.literal(s);
                    }))]),
        ...
        ViewBuilder.prototype.visitEmbeddedTemplate = function (ast, context) {
            ...
            this.nodes[nodeIndex] = function () {
                return {
                    ...
                    nodeDef: o.importExpr(Identifiers.anchorDef).callFn([o.literal(flags), queryMatchesExpr, o.literal(ast.ngContentIndex), o.literal(childCount), _this._createElementHandleEventFn(nodeIndex, hostEvents), o.variable(childVisitor.viewName)])
                };
            };
        };
            ...
            if (pipe.pure) {
                ...
                this.nodes.push(function () {
                    return {
                        ...
                        , nodeDef: o.importExpr(Identifiers.purePipeDef).callFn([o.literal(checkIndex_1), o.literal(argCount)])
                    };
                });
        ...
        ViewBuilder.prototype._createPipe = function (sourceSpan, pipe) {
            ...
            this.nodes.push(function () {
                return {
                    ...
                    , nodeDef: o.importExpr(Identifiers.pipeDef).callFn([o.literal(flags), _this.outputCtx.importExpr(pipe.type.reference), o.literalArr(depExprs)])
                };
            });
            return nodeIndex;
        };
        ...
        ViewBuilder.prototype._createNodeExpressions = function () {
            ...
            var nodeDefExprs = this.nodes.map(function (factory, nodeIndex) {
                ...
                var logWithNodeDef = nodeFlags & 3 /* CatRenderNode */ ? new o.CommaExpr([LOG_VAR.callFn([]).callFn([]), nodeDef]) : nodeDef;
        ...
        ViewBuilder.prototype._createElementHandleEventFn = function (nodeIndex, handlers) {
            ...
            if (handleEventStmts.length > 0) {
                ...
                handleEventFn = o.fn([new o.FnParam(VIEW_VAR.name, o.INFERRED_TYPE), new o.FnParam(EVENT_NAME_VAR.name, o.INFERRED_TYPE), new o.FnParam(EventHandlerVars.event.name, o.INFERRED_TYPE)], tslib_1.__spread(preStmts, handleEventStmts, [new o.ReturnStatement(ALLOW_DEFAULT_VAR)]), o.INFERRED_TYPE);
            } else {
    ...
    function elementBindingDef(inputAst, dirAst) {
        switch (inputAst.type) {
            ...
            case 4 /* Animation */:
                var bindingType = 8 /* TypeProperty */ | (dirAst && dirAst.directive.isComponent ? 32 /* SyntheticHostProperty */ : 16 /* SyntheticProperty */);
