Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/ng_module_compiler', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var NgModuleCompiler = /** @class */function () {
        ...
        NgModuleCompiler.prototype.compile = function (ctx, ngModuleMeta, extraProviders) {
            ...
            var providerDefs = [componentFactoryResolverProviderDef(this.reflector, ctx, 0 /* None */, entryComponentFactories)].concat(providerParser.parse().map(function (provider) {
            ...
            this._createNgModuleFactory(ctx, ngModuleMeta.type.reference, o.importExpr(Identifiers.createModuleFactory).callFn([ctx.importExpr(ngModuleMeta.type.reference), o.literalArr(bootstrapComponents.map(function (id) {
            ...
            if (ngModuleMeta.id) {
                ...
                var registerFactoryStmt = o.importExpr(Identifiers.RegisterModuleFactoryFn).callFn([id, o.variable(ngModuleFactoryVar)]).toStmt();
        ...
        NgModuleCompiler.prototype._createNgModuleFactory = function (ctx, reference, value) {
            ...
            var ngModuleFactoryStmt = o.variable(ngModuleFactoryVar).set(value).toDeclStmt(o.importType(Identifiers.NgModuleFactory, [o.expressionType(ctx.importExpr(reference))], [o.TypeModifier.Const]), [o.StmtModifier.Final, o.StmtModifier.Exported]);
