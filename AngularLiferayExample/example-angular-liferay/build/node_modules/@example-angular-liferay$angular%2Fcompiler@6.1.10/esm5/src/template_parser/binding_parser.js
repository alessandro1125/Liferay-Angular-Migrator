Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/template_parser/binding_parser', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    var BindingParser = /** @class */function () {
        ...
        BindingParser.prototype._parseRegularEvent = function (name, expression, sourceSpan, targetMatchableAttrs, targetEvents) {
            ...
            var _a = tslib_1.__read(splitAtColon(name, [null, name]), 2),
                target = _a[0],
                eventName = _a[1];
            var ast = this._parseAction(expression, sourceSpan);
            targetMatchableAttrs.push([name, ast.source]);
