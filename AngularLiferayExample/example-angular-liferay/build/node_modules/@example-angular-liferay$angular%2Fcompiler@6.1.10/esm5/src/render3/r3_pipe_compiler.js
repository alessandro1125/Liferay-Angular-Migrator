Liferay.Loader.define('@example-angular-liferay$angular/compiler@6.1.10/esm5/src/render3/r3_pipe_compiler', ['module', 'exports', 'require'], function (module, exports, require) {
    ...
    export function compilePipeFromMetadata(metadata) {
        ...
        var type = new o.ExpressionType(o.importExpr(R3.PipeDef, [new o.ExpressionType(metadata.type), new o.ExpressionType(new o.LiteralExpr(metadata.pipeName))]));
