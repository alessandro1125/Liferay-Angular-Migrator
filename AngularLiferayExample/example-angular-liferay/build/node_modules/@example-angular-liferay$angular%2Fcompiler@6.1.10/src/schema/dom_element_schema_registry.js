Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/schema/dom_element_schema_registry", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/ml_parser/tags', '@example-angular-liferay$angular/compiler/src/util', '@example-angular-liferay$angular/compiler/src/schema/dom_security_schema', '@example-angular-liferay$angular/compiler/src/schema/element_schema_registry'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var dom_security_schema_1 = require("@example-angular-liferay$angular/compiler/src/schema/dom_security_schema");
        var element_schema_registry_1 = require("@example-angular-liferay$angular/compiler/src/schema/element_schema_registry");
        var BOOLEAN = 'boolean';
        var NUMBER = 'number';
        var STRING = 'string';
        var OBJECT = 'object';
