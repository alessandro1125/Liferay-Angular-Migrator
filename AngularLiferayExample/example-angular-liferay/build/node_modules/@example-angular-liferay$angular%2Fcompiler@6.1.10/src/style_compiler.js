Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/style_compiler", ['module', 'exports', 'require', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/shadow_css'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var shadow_css_1 = require("@example-angular-liferay$angular/compiler/src/shadow_css");
