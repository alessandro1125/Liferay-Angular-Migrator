Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/compiler_util/expression_converter", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/expression_parser/ast', '@example-angular-liferay$angular/compiler/src/identifiers', '@example-angular-liferay$angular/compiler/src/output/output_ast'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var cdAst = require("@example-angular-liferay$angular/compiler/src/expression_parser/ast");
        ...
        var _AstToIrVisitor = /** @class */function () {
            ...
            _AstToIrVisitor.prototype.visitInterpolation = function (ast, mode) {
                ...
                return ast.expressions.length <= 9 ? o.importExpr(identifiers_1.Identifiers.inlineInterpolate).callFn(args) : o.importExpr(identifiers_1.Identifiers.interpolate).callFn([args[0], o.literalArr(args.slice(1))]);
            };
