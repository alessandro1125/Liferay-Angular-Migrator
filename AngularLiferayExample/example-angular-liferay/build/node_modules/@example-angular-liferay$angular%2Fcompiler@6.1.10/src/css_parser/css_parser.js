Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/css_parser/css_parser", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/chars', '@example-angular-liferay$angular/compiler/src/parse_util', '@example-angular-liferay$angular/compiler/src/css_parser/css_ast', '@example-angular-liferay$angular/compiler/src/css_parser/css_lexer'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var chars = require("@example-angular-liferay$angular/compiler/src/chars");
        var parse_util_1 = require("@example-angular-liferay$angular/compiler/src/parse_util");
        var css_ast_1 = require("@example-angular-liferay$angular/compiler/src/css_parser/css_ast");
        var css_lexer_1 = require("@example-angular-liferay$angular/compiler/src/css_parser/css_lexer");
        var SPACE_OPERATOR = ' ';
        var css_lexer_2 = require("@example-angular-liferay$angular/compiler/src/css_parser/css_lexer");
        exports.CssToken = css_lexer_2.CssToken;
        var css_ast_2 = require("@example-angular-liferay$angular/compiler/src/css_parser/css_ast");
        ...
        var CssParser = /** @class */function () {
            ...
            CssParser.prototype._parseSimpleSelector = function (delimiters) {
                ...
                hasAttributeError = hasAttributeError || this._scanner.getMode() == css_lexer_1.CssLexerMode.ATTRIBUTE_SELECTOR;
            ...
            CssParser.prototype._parseValue = function (delimiters) {
                ...
                while (!characterContainsDelimiter(this._scanner.peek, delimiters)) {
                    var token = void 0;
                    if (previous != null && previous.type == css_lexer_1.CssTokenType.Identifier && this._scanner.peek == chars.$LPAREN) {
                ...
                switch (this._scanner.peek) {
                    ...
                    default:
                        ...
                        if (this._scanner.peek != chars.$COLON) {
                            ...
                            endToken = prop = new css_lexer_1.CssToken(prop.index, prop.column, prop.line, prop.type, propStr_1.join(' '));
                        }
...
//# sourceMappingURL=css_parser.js.map