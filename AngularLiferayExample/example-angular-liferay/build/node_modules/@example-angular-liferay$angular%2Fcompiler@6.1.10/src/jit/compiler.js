Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/jit/compiler", ['module', 'exports', 'require', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/constant_pool', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/output/output_interpreter', '@example-angular-liferay$angular/compiler/src/output/output_jit', '@example-angular-liferay$angular/compiler/src/util'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var ir = require("@example-angular-liferay$angular/compiler/src/output/output_ast");
        var output_interpreter_1 = require("@example-angular-liferay$angular/compiler/src/output/output_interpreter");
