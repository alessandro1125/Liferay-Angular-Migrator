Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/template_parser/template_parser", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/expression_parser/ast', '@example-angular-liferay$angular/compiler/src/identifiers', '@example-angular-liferay$angular/compiler/src/ml_parser/ast', '@example-angular-liferay$angular/compiler/src/ml_parser/html_parser', '@example-angular-liferay$angular/compiler/src/ml_parser/html_whitespaces', '@example-angular-liferay$angular/compiler/src/ml_parser/icu_ast_expander', '@example-angular-liferay$angular/compiler/src/ml_parser/interpolation_config', '@example-angular-liferay$angular/compiler/src/ml_parser/tags', '@example-angular-liferay$angular/compiler/src/parse_util', '@example-angular-liferay$angular/compiler/src/provider_analyzer', '@example-angular-liferay$angular/compiler/src/selector', '@example-angular-liferay$angular/compiler/src/style_url_resolver', '@example-angular-liferay$angular/compiler/src/util', '@example-angular-liferay$angular/compiler/src/template_parser/binding_parser', '@example-angular-liferay$angular/compiler/src/template_parser/template_ast', '@example-angular-liferay$angular/compiler/src/template_parser/template_preparser'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var icu_ast_expander_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/icu_ast_expander");
        ...
        var style_url_resolver_1 = require("@example-angular-liferay$angular/compiler/src/style_url_resolver");
        ...
        var t = require("@example-angular-liferay$angular/compiler/src/template_parser/template_ast");
        var template_preparser_1 = require("@example-angular-liferay$angular/compiler/src/template_parser/template_preparser");
        ...
        var TemplateParseVisitor = /** @class */function () {
            ...
            TemplateParseVisitor.prototype._checkPropertiesInSchema = function (elementName, boundProps) {
                ...
                return boundProps.filter(function (boundProp) {
                    if (boundProp.type === 0 /* Property */ && !_this._schemaRegistry.hasProperty(elementName, boundProp.name, _this._schemas)) {
