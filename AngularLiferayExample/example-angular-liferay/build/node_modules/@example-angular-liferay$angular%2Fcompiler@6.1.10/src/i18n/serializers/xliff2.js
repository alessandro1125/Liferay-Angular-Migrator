Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/i18n/serializers/xliff2", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/ml_parser/ast', '@example-angular-liferay$angular/compiler/src/ml_parser/xml_parser', '@example-angular-liferay$angular/compiler/src/i18n/digest', '@example-angular-liferay$angular/compiler/src/i18n/i18n_ast', '@example-angular-liferay$angular/compiler/src/i18n/parse_util', '@example-angular-liferay$angular/compiler/src/i18n/serializers/serializer', '@example-angular-liferay$angular/compiler/src/i18n/serializers/xml_helper'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var ml = require("@example-angular-liferay$angular/compiler/src/ml_parser/ast");
        var xml_parser_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/xml_parser");
        var digest_1 = require("@example-angular-liferay$angular/compiler/src/i18n/digest");
        var i18n = require("@example-angular-liferay$angular/compiler/src/i18n/i18n_ast");
        var parse_util_1 = require("@example-angular-liferay$angular/compiler/src/i18n/parse_util");
            ...
            Xliff2.prototype.write = function (messages, locale) {
                ...
                messages.forEach(function (message) {
                    ...
                    message.sources.forEach(function (source) {
                        notes.children.push(new xml.CR(8), new xml.Tag('note', { category: 'location' }, [new xml.Text(source.filePath + ":" + source.startLine + (source.endLine !== source.startLine ? ',' + source.endLine : ''))]));
                    });
