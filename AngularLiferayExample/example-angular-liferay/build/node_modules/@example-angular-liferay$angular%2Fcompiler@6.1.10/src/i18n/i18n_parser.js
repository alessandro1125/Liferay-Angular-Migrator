Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/i18n/i18n_parser", ['module', 'exports', 'require', '@example-angular-liferay$angular/compiler/src/expression_parser/lexer', '@example-angular-liferay$angular/compiler/src/expression_parser/parser', '@example-angular-liferay$angular/compiler/src/ml_parser/ast', '@example-angular-liferay$angular/compiler/src/ml_parser/html_tags', '@example-angular-liferay$angular/compiler/src/i18n/i18n_ast', '@example-angular-liferay$angular/compiler/src/i18n/serializers/placeholder'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var placeholder_1 = require("@example-angular-liferay$angular/compiler/src/i18n/serializers/placeholder");
