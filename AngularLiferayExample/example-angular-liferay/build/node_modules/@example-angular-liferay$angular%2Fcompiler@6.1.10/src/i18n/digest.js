Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/i18n/digest", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/util'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        function sha1(str) {
            ...
            var w = new Array(80);
            var _c = tslib_1.__read([0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0xc3d2e1f0], 5),
                a = _c[0],
                b = _c[1],
                c = _c[2],
                d = _c[3],
            ...
            for (var i = 0; i < words32.length; i += 16) {
                var _d = tslib_1.__read([a, b, c, d, e], 5),
                    h0 = _d[0],
                    h1 = _d[1],
                    h2 = _d[2],
                    h3 = _d[3],
                ...
                for (var j = 0; j < 80; j++) {
                    ...
                    var _e = tslib_1.__read(fk(j, b, c, d), 2),
                        f = _e[0],
                        k = _e[1];
        ...
        function fingerprint(str) {
            var utf8 = util_1.utf8Encode(str);
            var _a = tslib_1.__read([hash32(utf8, 0), hash32(utf8, 102072)], 2),
                hi = _a[0],
                lo = _a[1];
            if (hi == 0 && (lo == 0 || lo == 1)) {
                hi = hi ^ 0x130f9bef;
        ...
        function computeMsgId(msg, meaning) {
            var _a;
            var _b = tslib_1.__read(fingerprint(msg), 2),
                hi = _b[0],
                lo = _b[1];
            if (meaning) {
                var _c = tslib_1.__read(fingerprint(meaning), 2),
                    him = _c[0],
                    lom = _c[1];
        ...
        function hash32(str, c) {
            var _a;
            var _b = tslib_1.__read([0x9e3779b9, 0x9e3779b9], 2),
                a = _b[0],
                b = _b[1];
            var i;
            var len = str.length;
        ...
        function add64(_a, _b) {
            ...
            var _d = tslib_1.__read(_b, 2),
                bh = _d[0],
                bl = _d[1];
            var _e = tslib_1.__read(add32to64(al, bl), 2),
                carry = _e[0],
                l = _e[1];
