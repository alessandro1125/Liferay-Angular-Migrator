Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/aot/compiler", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/constant_pool', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/i18n/message_bundle', '@example-angular-liferay$angular/compiler/src/identifiers', '@example-angular-liferay$angular/compiler/src/ml_parser/html_parser', '@example-angular-liferay$angular/compiler/src/ml_parser/html_whitespaces', '@example-angular-liferay$angular/compiler/src/ml_parser/interpolation_config', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/render3/r3_module_compiler', '@example-angular-liferay$angular/compiler/src/render3/r3_pipe_compiler', '@example-angular-liferay$angular/compiler/src/render3/r3_template_transform', '@example-angular-liferay$angular/compiler/src/render3/view/compiler', '@example-angular-liferay$angular/compiler/src/schema/dom_element_schema_registry', '@example-angular-liferay$angular/compiler/src/template_parser/binding_parser', '@example-angular-liferay$angular/compiler/src/util', '@example-angular-liferay$angular/compiler/src/aot/generated_file', '@example-angular-liferay$angular/compiler/src/aot/lazy_routes', '@example-angular-liferay$angular/compiler/src/aot/static_symbol', '@example-angular-liferay$angular/compiler/src/aot/summary_serializer', '@example-angular-liferay$angular/compiler/src/aot/util'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var compiler_1 = require("@example-angular-liferay$angular/compiler/src/render3/view/compiler");
        ...
        var generated_file_1 = require("@example-angular-liferay$angular/compiler/src/aot/generated_file");
        var lazy_routes_1 = require("@example-angular-liferay$angular/compiler/src/aot/lazy_routes");
        var static_symbol_1 = require("@example-angular-liferay$angular/compiler/src/aot/static_symbol");
        var summary_serializer_1 = require("@example-angular-liferay$angular/compiler/src/aot/summary_serializer");
        var util_2 = require("@example-angular-liferay$angular/compiler/src/aot/util");
        var AotCompiler = /** @class */function () {
            ...
            AotCompiler.prototype._createNgFactoryStub = function (outputCtx, file, emitFlags) {
                ...
                file.ngModules.forEach(function (ngModuleMeta, ngModuleIndex) {
                    ...
                    externalReferenceVars.forEach(function (varName, reference) {
                        outputCtx.statements.push(o.variable(varName).set(o.NULL_EXPR.cast(o.DYNAMIC_TYPE)).toDeclStmt(o.expressionType(outputCtx.importExpr(reference, /* typeParams */null, /* useSummaries */false))));
                    });
            ...
            AotCompiler.prototype._createSummary = function (srcFileName, directives, pipes, ngModules, injectables, ngFactoryCtx) {
                ...
                var _a = summary_serializer_1.serializeSummaries(srcFileName, forJitOutputCtx, this._summaryResolver, this._symbolResolver, symbolSummaries, typeData),
                    json = _a.json,
