Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/render3/r3_jit", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/output/output_jit'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var output_jit_1 = require("@example-angular-liferay$angular/compiler/src/output/output_jit");
        /**
        ...
        function jitExpression(def, context, sourceUrl, constantPool) {
            ...
            var statements = tslib_1.__spread(constantPool !== undefined ? constantPool.statements : [], [new o.DeclareVarStmt('$def', def, undefined, [o.StmtModifier.Exported])]);
