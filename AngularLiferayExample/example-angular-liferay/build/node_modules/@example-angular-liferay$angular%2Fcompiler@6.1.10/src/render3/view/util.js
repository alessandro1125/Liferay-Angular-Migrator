Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/render3/view/util", ['module', 'exports', 'require', '@example-angular-liferay$angular/compiler/src/output/output_ast'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        function mapToExpression(map, quoted) {
            ...
            return o.literalMap(Object.getOwnPropertyNames(map).map(function (key) {
                return { key: key, quoted: quoted, value: asLiteral(map[key]) };
            }));
        }
        ...
        function getQueryPredicate(query, constantPool) {
            if (Array.isArray(query.predicate)) {
                return constantPool.getConstLiteral(o.literalArr(query.predicate.map(function (selector) {
