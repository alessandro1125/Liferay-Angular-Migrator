Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/render3/view/template", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/compiler_util/expression_converter', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/expression_parser/ast', '@example-angular-liferay$angular/compiler/src/expression_parser/lexer', '@example-angular-liferay$angular/compiler/src/expression_parser/parser', '@example-angular-liferay$angular/compiler/src/ml_parser/ast', '@example-angular-liferay$angular/compiler/src/ml_parser/html_parser', '@example-angular-liferay$angular/compiler/src/ml_parser/html_whitespaces', '@example-angular-liferay$angular/compiler/src/ml_parser/interpolation_config', '@example-angular-liferay$angular/compiler/src/ml_parser/tags', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/schema/dom_element_schema_registry', '@example-angular-liferay$angular/compiler/src/selector', '@example-angular-liferay$angular/compiler/src/template_parser/binding_parser', '@example-angular-liferay$angular/compiler/src/util', '@example-angular-liferay$angular/compiler/src/render3/r3_ast', '@example-angular-liferay$angular/compiler/src/render3/r3_identifiers', '@example-angular-liferay$angular/compiler/src/render3/r3_template_transform', '@example-angular-liferay$angular/compiler/src/render3/view/styling', '@example-angular-liferay$angular/compiler/src/render3/view/util'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var ast_1 = require("@example-angular-liferay$angular/compiler/src/expression_parser/ast");
        ...
        var html = require("@example-angular-liferay$angular/compiler/src/ml_parser/ast");
        var html_parser_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/html_parser");
        var html_whitespaces_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/html_whitespaces");
        var interpolation_config_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/interpolation_config");
        var tags_1 = require("@example-angular-liferay$angular/compiler/src/ml_parser/tags");
        ...
        var binding_parser_1 = require("@example-angular-liferay$angular/compiler/src/template_parser/binding_parser");
        var util_1 = require("@example-angular-liferay$angular/compiler/src/util");
        var t = require("@example-angular-liferay$angular/compiler/src/render3/r3_ast");
        var r3_identifiers_1 = require("@example-angular-liferay$angular/compiler/src/render3/r3_identifiers");
        var r3_template_transform_1 = require("@example-angular-liferay$angular/compiler/src/render3/r3_template_transform");
        var styling_1 = require("@example-angular-liferay$angular/compiler/src/render3/view/styling");
        var util_2 = require("@example-angular-liferay$angular/compiler/src/render3/view/util");
        ...
        var TemplateDefinitionBuilder = /** @class */function () {
                ...
                try {
                    ...
                    for (var _c = tslib_1.__values(this._phToNodeIdxes), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        if (Object.keys(phToNodeIdx).length > 0) {
                            var scopedName = this._bindingScope.freshReferenceName();
                            var phMap = o.variable(scopedName).set(util_2.mapToExpression(phToNodeIdx, true)).toDeclStmt(o.INFERRED_TYPE, [o.StmtModifier.Final]);
            ...
            TemplateDefinitionBuilder.prototype.visitElement = function (element) {
                ...
                if (element.references && element.references.length > 0) {
                    var references = compile_metadata_1.flatten(element.references.map(function (reference) {
                        ...
                        _this._variableCode.push(o.variable(variableName, o.INFERRED_TYPE).set(o.importExpr(r3_identifiers_1.Identifiers.load).callFn([o.literal(slot)])).toDeclStmt(o.INFERRED_TYPE, [o.StmtModifier.Final]));
                ...
                if (createSelfClosingInstruction) {
                    ...
                    element.outputs.forEach(function (outputAst) {
                        ...
                        var bindingExpr = expression_converter_1.convertActionBinding(bindingScope, implicit, outputAst.handler, 'b', function () {
                ...
                if ((styleInputs.length || classInputs.length) && hasStylingInstructions) {
                    ...
                    if (styleInputs.length) {
                        ...
                        for (i; i < styleInputs.length; i++) {
                            ...
                            this.instruction.apply(this, tslib_1.__spread([this._bindingCode, input.sourceSpan, r3_identifiers_1.Identifiers.elementStyleProp, indexLiteral, o.literal(styleIndex)], params));
                        }
                    ...
                    if (classInputs.length) {
                        ...
                        for (i; i < classInputs.length; i++) {
                            ...
                            this.instruction.apply(this, tslib_1.__spread([this._bindingCode, input.sourceSpan, r3_identifiers_1.Identifiers.elementClassProp, indexLiteral, o.literal(classIndex)], params));
                        }
            ...
            TemplateDefinitionBuilder.prototype.convertPropertyBinding = function (implicit, value, skipBindFn) {
                ...
                if (pipesConvertedValue instanceof ast_1.Interpolation) {
                    ...
                    var convertedPropertyBinding = expression_converter_1.convertPropertyBinding(this, implicit, pipesConvertedValue, this.bindingContext(), expression_converter_1.BindingForm.TrySimple, function () {
                        return util_1.error('Unexpected interpolation');
                    });
        ...
        var ValueConverter = /** @class */function (_super) {
            ...
            ValueConverter.prototype.visitPipe = function (pipe, context) {
                ...
                return new ast_1.FunctionCall(pipe.span, target, tslib_1.__spread([new ast_1.LiteralPrimitive(pipe.span, slot), new ast_1.LiteralPrimitive(pipe.span, pureFunctionSlot)], convertedArgs));
            };
        ...
        var BindingScope = /** @class */function () {
            function BindingScope(parent, declareLocalVarCallback) {
                ...
                if (declareLocalVarCallback === void 0) {
                    declareLocalVarCallback = util_2.noop;
                }
                this.parent = parent;
            ...
            BindingScope.prototype.set = function (name, lhs, rhs) {
                !this.map.has(name) || util_1.error("The name " + name + " is already defined in scope to be " + this.map.get(name));
        ...
        function interpolate(args) {
            ...
            args.length >= 19 && args.length % 2 == 1 || util_1.error("Invalid interpolation argument length " + args.length);
        ...
        function parseTemplate(template, templateUrl, options) {
            ...
            var _a = r3_template_transform_1.htmlAstToRender3Ast(rootNodes, bindingParser),
                nodes = _a.nodes,
