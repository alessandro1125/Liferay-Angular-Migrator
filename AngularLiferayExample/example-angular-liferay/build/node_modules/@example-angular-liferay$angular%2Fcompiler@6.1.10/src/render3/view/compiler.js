Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/render3/view/compiler", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/compiler_util/expression_converter', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/lifecycle_reflector', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/parse_util', '@example-angular-liferay$angular/compiler/src/selector', '@example-angular-liferay$angular/compiler/src/util', '@example-angular-liferay$angular/compiler/src/render3/r3_factory', '@example-angular-liferay$angular/compiler/src/render3/r3_identifiers', '@example-angular-liferay$angular/compiler/src/render3/util', '@example-angular-liferay$angular/compiler/src/render3/view/template', '@example-angular-liferay$angular/compiler/src/render3/view/util'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var expression_converter_1 = require("@example-angular-liferay$angular/compiler/src/compiler_util/expression_converter");
        var core = require("@example-angular-liferay$angular/compiler/src/core");
        var lifecycle_reflector_1 = require("@example-angular-liferay$angular/compiler/src/lifecycle_reflector");
        ...
        var util_2 = require("@example-angular-liferay$angular/compiler/src/render3/util");
        var template_1 = require("@example-angular-liferay$angular/compiler/src/render3/view/template");
        var util_3 = require("@example-angular-liferay$angular/compiler/src/render3/view/util");
        ...
        function compileDirectiveFromMetadata(meta, constantPool, bindingParser) {
            ...
            var type = new o.ExpressionType(o.importExpr(r3_identifiers_1.Identifiers.DirectiveDef, [util_2.typeWithParameters(meta.type, meta.typeArgumentCount), new o.ExpressionType(o.literal(selectorForType))]));
        ...
        function compileComponentFromMetadata(meta, constantPool, bindingParser) {
            ...
            var templateFunctionExpression = new template_1.TemplateDefinitionBuilder(constantPool, util_3.CONTEXT_NAME, template_1.BindingScope.ROOT_SCOPE, 0, templateTypeName, templateName, meta.viewQueries, directiveMatcher, directivesUsed, meta.pipes, pipesUsed, r3_identifiers_1.Identifiers.namespaceHTML).buildTemplateFunction(template.nodes, [], template.hasNgContent, template.ngContentSelectors);
            ...
            var type = new o.ExpressionType(o.importExpr(r3_identifiers_1.Identifiers.ComponentDef, [util_2.typeWithParameters(meta.type, meta.typeArgumentCount), new o.ExpressionType(o.literal(selectorForType))]));
            return { expression: expression, type: type };
        }
        ...
        function directiveMetadataFromGlobalMetadata(directive, outputCtx, reflector) {
            ...
            return {
                ...
                lifecycle: {
                    usesOnChanges: directive.type.lifecycleHooks.some(function (lifecycle) {
                        return lifecycle == lifecycle_reflector_1.LifecycleHooks.OnChanges;
                    })
                },
                host: {
        ...
        function createQueryDefinition(query, constantPool, idx) {
            ...
            var parameters = [o.literal(idx, o.INFERRED_TYPE), predicate, o.literal(query.descendants)];
            if (query.read) {
        ...
        function createContentQueriesRefreshFunction(meta) {
            if (meta.queries.length > 0) {
                var statements_1 = [];
                var typeName = meta.name;
                var parameters = [new o.FnParam('dirIndex', o.NUMBER_TYPE), new o.FnParam('queryStartIndex', o.NUMBER_TYPE)];
                ...
                statements_1.push(directiveInstanceVar_1.set(o.importExpr(r3_identifiers_1.Identifiers.loadDirective).callFn([o.variable('dirIndex')])).toDeclStmt(o.INFERRED_TYPE, [o.StmtModifier.Final]));
                meta.queries.forEach(function (query, idx) {
                    var loadQLArg = o.variable('queryStartIndex');
                    var getQueryList = o.importExpr(r3_identifiers_1.Identifiers.loadQueryList).callFn([idx > 0 ? loadQLArg.plus(o.literal(idx)) : loadQLArg]);
                    ...
                    var updateDirective = directiveInstanceVar_1.prop(query.propertyName).set(query.first ? temporary_1().prop('first') : temporary_1());
        ...
        function createViewQueriesFunction(meta, constantPool) {
            ...
            return o.fn([new o.FnParam(util_3.RENDER_FLAGS, o.NUMBER_TYPE), new o.FnParam(util_3.CONTEXT_NAME, null)], [template_1.renderFlagCheckIfStmt(1 /* Create */, createStatements), template_1.renderFlagCheckIfStmt(2 /* Update */, updateStatements)], o.INFERRED_TYPE, null, viewQueryFnName);
        }
            ...
            if (bindings) {
                try {
                    for (var bindings_1 = tslib_1.__values(bindings), bindings_1_1 = bindings_1.next(); !bindings_1_1.done; bindings_1_1 = bindings_1.next()) {
                        ...
                        var bindingExpr = expression_converter_1.convertPropertyBinding(null, bindingContext, binding.expression, 'b', expression_converter_1.BindingForm.TrySimple, function () {
                            return util_1.error('Unexpected interpolation');
                        });
                        statements.push.apply(statements, tslib_1.__spread(bindingExpr.stmts));
                        statements.push(o.importExpr(r3_identifiers_1.Identifiers.elementProperty).callFn([o.variable('elIndex'), o.literal(binding.name), o.importExpr(r3_identifiers_1.Identifiers.bind).callFn([bindingExpr.currValExpr])]).toStmt());
                    }
                } catch (e_2_1) {
                    e_2 = { error: e_2_1 };
                } finally {
            ...
            if (eventBindings) {
                try {
                    for (var eventBindings_1 = tslib_1.__values(eventBindings), eventBindings_1_1 = eventBindings_1.next(); !eventBindings_1_1.done; eventBindings_1_1 = eventBindings_1.next()) {
                        ...
                        var bindingExpr = expression_converter_1.convertActionBinding(null, bindingContext, binding.handler, 'b', function () {
                            return util_1.error('Unexpected interpolation');
                        });
