Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/view_compiler/view_compiler", ['module', 'exports', 'require', 'example-angular-liferay$tslib', '@example-angular-liferay$angular/compiler/src/compile_metadata', '@example-angular-liferay$angular/compiler/src/compiler_util/expression_converter', '@example-angular-liferay$angular/compiler/src/core', '@example-angular-liferay$angular/compiler/src/identifiers', '@example-angular-liferay$angular/compiler/src/lifecycle_reflector', '@example-angular-liferay$angular/compiler/src/ml_parser/tags', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/output/value_util', '@example-angular-liferay$angular/compiler/src/template_parser/template_ast', '@example-angular-liferay$angular/compiler/src/view_compiler/provider_compiler'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        var template_ast_1 = require("@example-angular-liferay$angular/compiler/src/template_parser/template_ast");
                ...
                if (this.parent && (astNodes.length === 0 || needsAdditionalRootNode(astNodes))) {
                    ...
                    this.nodes.push(function () {
                        return {
                            ...
                            , nodeDef: o.importExpr(identifiers_1.Identifiers.anchorDef).callFn([o.literal(0 /* None */), o.NULL_EXPR, o.NULL_EXPR, o.literal(0)])
                        };
                    });
                }
            };
