Liferay.Loader.define("@example-angular-liferay$angular/compiler@6.1.10/src/view_compiler/provider_compiler", ['module', 'exports', 'require', '@example-angular-liferay$angular/compiler/src/identifiers', '@example-angular-liferay$angular/compiler/src/lifecycle_reflector', '@example-angular-liferay$angular/compiler/src/output/output_ast', '@example-angular-liferay$angular/compiler/src/output/value_util', '@example-angular-liferay$angular/compiler/src/template_parser/template_ast'], function (module, exports, require) {
    ...
    (function (factory) {
        ...
        function componentFactoryResolverProviderDef(reflector, ctx, flags, entryComponents) {
            ...
            var classMeta = {
                diDeps: [{ isValue: true, value: o.literalArr(entryComponentFactories) }, { token: token, isSkipSelf: true, isOptional: true }, { token: identifiers_1.createTokenForExternalReference(reflector, identifiers_1.Identifiers.NgModuleRef) }],
                lifecycleHooks: [],
