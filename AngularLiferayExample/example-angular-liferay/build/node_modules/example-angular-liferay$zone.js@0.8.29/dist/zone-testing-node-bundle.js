Liferay.Loader.define('example-angular-liferay$zone.js@0.8.29/dist/zone-testing-node-bundle', ['module', 'exports', 'require', 'example-angular-liferay$events', 'example-angular-liferay$fs', 'example-angular-liferay$timers', 'example-angular-liferay$crypto'], function (module, exports, require) {
    ...
    */
    (function (global, factory) {
        ...
        Zone.__load_patch('EventEmitter', function (global) {
            ...
            var events;
            try {
                events = require('example-angular-liferay$events');
            } catch (err) {}
        ...
        Zone.__load_patch('fs', function () {
            var fs;
            try {
                fs = require('example-angular-liferay$fs');
            } catch (err) {}
        ...
        Zone.__load_patch('node_timers', function (global, Zone) {
            ...
            try {
                var timers = require('example-angular-liferay$timers');
        ...
        Zone.__load_patch('crypto', function () {
            var crypto;
            try {
                crypto = require('example-angular-liferay$crypto');
            } catch (err) {}
        ...
        Zone.__load_patch('fakeasync', function (global, Zone, api) {
            ...
            Zone[api.symbol('fakeAsyncTest')] = { resetFakeAsyncZone: resetFakeAsyncZone, flushMicrotasks: flushMicrotasks, discardPeriodicTasks: discardPeriodicTasks, tick: tick, flush: flush, fakeAsync: fakeAsync };
        });
...
//# sourceMappingURL=zone-testing-node-bundle.js.map